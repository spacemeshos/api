...
var file_spacemesh_v1_debug_proto_rawDesc = []byte{
	...
	,
...
var file_spacemesh_v1_debug_proto_goTypes = []interface{}{
	...
	(*PublicKeyResponse)(nil), // 2: spacemesh.v1.PublicKeyResponse
}
var file_spacemesh_v1_debug_proto_depIdxs = []int32{
	0, // 0: spacemesh.v1.DebugService.Accounts:input_type -> google.protobuf.Empty
	0, // 1: spacemesh.v1.DebugService.PublicKey:input_type -> google.protobuf.Empty
	1, // 2: spacemesh.v1.DebugService.Accounts:output_type -> spacemesh.v1.AccountsResponse
	2, // 3: spacemesh.v1.DebugService.PublicKey:output_type -> spacemesh.v1.PublicKeyResponse
...
type DebugServiceClient interface {
	...
	PublicKey(ctx context.Context, in *empty.Empty, opts ...grpc.CallOption) (*PublicKeyResponse, error)
}
...
func (c *debugServiceClient) PublicKey(ctx context.Context, in *empty.Empty, opts ...grpc.CallOption) (*PublicKeyResponse, error) {
	out := new(PublicKeyResponse)
	err := c.cc.Invoke(ctx, "/spacemesh.v1.DebugService/PublicKey", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type DebugServiceServer interface {
	...
	// PublicKey returns this node's public key
	// Useful for quickly bootstraping nodes in development
	PublicKey(context.Context, *empty.Empty) (*PublicKeyResponse, error)
}
...
func (*UnimplementedDebugServiceServer) PublicKey(context.Context, *empty.Empty) (*PublicKeyResponse, error) {
...
func _DebugService_PublicKey_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(empty.Empty)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(DebugServiceServer).PublicKey(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/spacemesh.v1.DebugService/PublicKey",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(DebugServiceServer).PublicKey(ctx, req.(*empty.Empty))
	}
	return interceptor(ctx, in, info, handler)
}
...
var _DebugService_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _DebugService_PublicKey_Handler,
		},
	},
