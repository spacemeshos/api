...
var file_spacemesh_v1_debug_proto_rawDesc = []byte{
	...
	0x70, 0x72, 0x6f, 0x74, 0x6f, 0x32, 0xaf, 0x02, 0x0a, 0x0c, 0x44, 0x65, 0x62, 0x75, 0x67, 0x53,
	...
	0x6f, 0x6e, 0x73, 0x65, 0x12, 0x4c, 0x0a, 0x09, 0x41, 0x63, 0x74, 0x69, 0x76, 0x65, 0x53, 0x65,
	0x74, 0x12, 0x1e, 0x2e, 0x73, 0x70, 0x61, 0x63, 0x65, 0x6d, 0x65, 0x73, 0x68, 0x2e, 0x76, 0x31,
	0x2e, 0x41, 0x63, 0x74, 0x69, 0x76, 0x65, 0x53, 0x65, 0x74, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73,
	0x74, 0x1a, 0x1f, 0x2e, 0x73, 0x70, 0x61, 0x63, 0x65, 0x6d, 0x65, 0x73, 0x68, 0x2e, 0x76, 0x31,
	0x2e, 0x41, 0x63, 0x74, 0x69, 0x76, 0x65, 0x53, 0x65, 0x74, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e,
	0x73, 0x65, 0x12, 0x43, 0x0a, 0x0f, 0x50, 0x72, 0x6f, 0x70, 0x6f, 0x73, 0x61, 0x6c, 0x73, 0x53,
	...
	0x70, 0x6f, 0x73, 0x61, 0x6c, 0x30, 0x01, 0x42, 0x34, 0x5a, 0x32, 0x67, 0x69, 0x74, 0x68, 0x75,
...
var file_spacemesh_v1_debug_proto_goTypes = []interface{}{
	...
	(*ActiveSetRequest)(nil),    // 1: spacemesh.v1.ActiveSetRequest
	(*NetworkInfoResponse)(nil), // 2: spacemesh.v1.NetworkInfoResponse
	(*AccountsResponse)(nil),    // 3: spacemesh.v1.AccountsResponse
	(*ActiveSetResponse)(nil),   // 4: spacemesh.v1.ActiveSetResponse
...
var file_spacemesh_v1_debug_proto_depIdxs = []int32{
	...
	1, // 2: spacemesh.v1.DebugService.ActiveSet:input_type -> spacemesh.v1.ActiveSetRequest
	0, // 3: spacemesh.v1.DebugService.ProposalsStream:input_type -> google.protobuf.Empty
	2, // 4: spacemesh.v1.DebugService.NetworkInfo:output_type -> spacemesh.v1.NetworkInfoResponse
	3, // 5: spacemesh.v1.DebugService.Accounts:output_type -> spacemesh.v1.AccountsResponse
	4, // 6: spacemesh.v1.DebugService.ActiveSet:output_type -> spacemesh.v1.ActiveSetResponse
	5, // 7: spacemesh.v1.DebugService.ProposalsStream:output_type -> spacemesh.v1.Proposal
