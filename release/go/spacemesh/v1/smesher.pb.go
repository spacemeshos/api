...
var file_spacemesh_v1_smesher_proto_rawDesc = []byte{
	...
	0x70, 0x65, 0x73, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x32, 0xa0, 0x09, 0x0a, 0x0e, 0x53, 0x6d,
	...
	0x6e, 0x66, 0x69, 0x67, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x4e, 0x0a, 0x0e,
	...
	0x61, 0x74, 0x75, 0x73, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x42, 0x34, 0x5a, 0x32,
...
var file_spacemesh_v1_smesher_proto_goTypes = []interface{}{
	...
	(*SmeshingStatusResponse)(nil),            // 20: spacemesh.v1.SmeshingStatusResponse
}
var file_spacemesh_v1_smesher_proto_depIdxs = []int32{
	...
	0,  // 13: spacemesh.v1.SmesherService.SmeshingStatus:input_type -> google.protobuf.Empty
	...
	11, // 18: spacemesh.v1.SmesherService.Coinbase:output_type -> spacemesh.v1.CoinbaseResponse
	12, // 19: spacemesh.v1.SmesherService.SetCoinbase:output_type -> spacemesh.v1.SetCoinbaseResponse
	13, // 20: spacemesh.v1.SmesherService.MinGas:output_type -> spacemesh.v1.MinGasResponse
	14, // 21: spacemesh.v1.SmesherService.SetMinGas:output_type -> spacemesh.v1.SetMinGasResponse
	15, // 22: spacemesh.v1.SmesherService.EstimatedRewards:output_type -> spacemesh.v1.EstimatedRewardsResponse
	16, // 23: spacemesh.v1.SmesherService.PostSetupStatus:output_type -> spacemesh.v1.PostSetupStatusResponse
	17, // 24: spacemesh.v1.SmesherService.PostSetupStatusStream:output_type -> spacemesh.v1.PostSetupStatusStreamResponse
	18, // 25: spacemesh.v1.SmesherService.PostSetupComputeProviders:output_type -> spacemesh.v1.PostSetupComputeProvidersResponse
	19, // 26: spacemesh.v1.SmesherService.PostConfig:output_type -> spacemesh.v1.PostConfigResponse
	20, // 27: spacemesh.v1.SmesherService.SmeshingStatus:output_type -> spacemesh.v1.SmeshingStatusResponse
...
type SmesherServiceClient interface {
	...
	// Returns info about current epoch.
