...
func (x *ChangeLogLevelResponse) GetStatus() *status.Status {
	if x != nil {
		return x.Status
	}
	return nil
...
var file_spacemesh_v1_debug_types_proto_rawDesc = []byte{
	...
	0x44, 0x0a, 0x16, 0x43, 0x68, 0x61, 0x6e, 0x67, 0x65, 0x4c, 0x6f, 0x67, 0x4c, 0x65, 0x76, 0x65,
	...
	0x74, 0x61, 0x74, 0x75, 0x73, 0x42, 0xb4, 0x01, 0x0a, 0x10, 0x63, 0x6f, 0x6d, 0x2e, 0x73, 0x70,
	0x61, 0x63, 0x65, 0x6d, 0x65, 0x73, 0x68, 0x2e, 0x76, 0x31, 0x42, 0x0f, 0x44, 0x65, 0x62, 0x75,
	0x67, 0x54, 0x79, 0x70, 0x65, 0x73, 0x50, 0x72, 0x6f, 0x74, 0x6f, 0x50, 0x01, 0x5a, 0x3e, 0x67,
...
var file_spacemesh_v1_debug_types_proto_msgTypes = make([]protoimpl.MessageInfo, 10)
var file_spacemesh_v1_debug_types_proto_goTypes = []interface{}{
	...
	(*ChangeLogLevelResponse)(nil),        // 12: spacemesh.v1.ChangeLogLevelResponse
	(*Account)(nil),                       // 13: spacemesh.v1.Account
	(*ActivationId)(nil),                  // 14: spacemesh.v1.ActivationId
	(*EpochNumber)(nil),                   // 15: spacemesh.v1.EpochNumber
	(*LayerNumber)(nil),                   // 16: spacemesh.v1.LayerNumber
	(*SmesherId)(nil),                     // 17: spacemesh.v1.SmesherId
	(*status.Status)(nil),                 // 18: google.rpc.Status
}
var file_spacemesh_v1_debug_types_proto_depIdxs = []int32{
	13, // 0: spacemesh.v1.AccountsResponse.account_wrapper:type_name -> spacemesh.v1.Account
	...
	14, // 4: spacemesh.v1.ActiveSetResponse.ids:type_name -> spacemesh.v1.ActivationId
	15, // 5: spacemesh.v1.Proposal.epoch:type_name -> spacemesh.v1.EpochNumber
	16, // 6: spacemesh.v1.Proposal.layer:type_name -> spacemesh.v1.LayerNumber
	17, // 7: spacemesh.v1.Proposal.smesher:type_name -> spacemesh.v1.SmesherId
	...
	18, // 11: spacemesh.v1.ChangeLogLevelResponse.status:type_name -> google.rpc.Status
