...
func (c *smeshingIdentitiesServiceClient) States(ctx context.Context, in *IdentityStatesRequest, opts ...grpc.CallOption) (*IdentityStatesResponse, error) {
	...
	err := c.cc.Invoke(ctx, SmeshingIdentitiesService_States_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *smeshingIdentitiesServiceClient) PoetInfo(ctx context.Context, in *PoetInfoRequest, opts ...grpc.CallOption) (*PoetInfoResponse, error) {
	...
	err := c.cc.Invoke(ctx, SmeshingIdentitiesService_PoetInfo_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *smeshingIdentitiesServiceClient) Eligibilities(ctx context.Context, in *EligibilitiesRequest, opts ...grpc.CallOption) (*EligibilitiesResponse, error) {
	...
	err := c.cc.Invoke(ctx, SmeshingIdentitiesService_Eligibilities_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *smeshingIdentitiesServiceClient) Proposals(ctx context.Context, in *ProposalsRequest, opts ...grpc.CallOption) (*ProposalsResponse, error) {
	...
	err := c.cc.Invoke(ctx, SmeshingIdentitiesService_Proposals_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
// UnimplementedSmeshingIdentitiesServiceServer should be embedded to have
...
func (UnimplementedSmeshingIdentitiesServiceServer) testEmbeddedByValue() {}
...
func RegisterSmeshingIdentitiesServiceServer(s grpc.ServiceRegistrar, srv SmeshingIdentitiesServiceServer) {
	// If the following call pancis, it indicates UnimplementedSmeshingIdentitiesServiceServer was
