...
var (
	pattern_MalfeasanceService_List_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1}, []string{"spacemesh.v2beta1.MalfeasanceService", "List"}, ""))
)
...
var (
	pattern_MalfeasanceStreamService_Stream_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1}, []string{"spacemesh.v2beta1.MalfeasanceStreamService", "Stream"}, ""))
)
