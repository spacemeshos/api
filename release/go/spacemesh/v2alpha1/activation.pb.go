...
type ActivationList struct {
	...
	Total       uint64        `protobuf:"varint,2,opt,name=total,proto3" json:"total,omitempty"` // Total number of activations in the requested range.
}
...
func (x *ActivationList) GetTotal() uint64 {
	if x != nil {
		return x.Total
	}
	return 0
...
var file_spacemesh_v2alpha1_activation_proto_rawDesc = []byte{
	...
	0x02, 0x20, 0x01, 0x28, 0x04, 0x52, 0x05, 0x74, 0x6f, 0x74, 0x61, 0x6c, 0x22, 0x3e, 0x0a, 0x17,
