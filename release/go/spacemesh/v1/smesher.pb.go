...
var file_spacemesh_v1_smesher_proto_rawDesc = []byte{
	...
	0x70, 0x65, 0x73, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x32, 0xad, 0x09, 0x0a, 0x0e, 0x53, 0x6d,
	...
	0x6e, 0x66, 0x69, 0x67, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x5b, 0x0a, 0x0e,
	0x53, 0x6d, 0x65, 0x73, 0x68, 0x69, 0x6e, 0x67, 0x53, 0x74, 0x61, 0x74, 0x75, 0x73, 0x12, 0x23,
	0x2e, 0x73, 0x70, 0x61, 0x63, 0x65, 0x6d, 0x65, 0x73, 0x68, 0x2e, 0x76, 0x31, 0x2e, 0x53, 0x6d,
	0x65, 0x73, 0x68, 0x69, 0x6e, 0x67, 0x53, 0x74, 0x61, 0x74, 0x75, 0x73, 0x52, 0x65, 0x71, 0x75,
	0x65, 0x73, 0x74, 0x1a, 0x24, 0x2e, 0x73, 0x70, 0x61, 0x63, 0x65, 0x6d, 0x65, 0x73, 0x68, 0x2e,
	0x76, 0x31, 0x2e, 0x53, 0x6d, 0x65, 0x73, 0x68, 0x69, 0x6e, 0x67, 0x53, 0x74, 0x61, 0x74, 0x75,
...
var file_spacemesh_v1_smesher_proto_goTypes = []interface{}{
	...
	(*SmeshingStatusRequest)(nil),             // 7: spacemesh.v1.SmeshingStatusRequest
	...
	(*PostSetupComputeProvidersResponse)(nil), // 19: spacemesh.v1.PostSetupComputeProvidersResponse
	(*PostConfigResponse)(nil),                // 20: spacemesh.v1.PostConfigResponse
	(*SmeshingStatusResponse)(nil),            // 21: spacemesh.v1.SmeshingStatusResponse
}
var file_spacemesh_v1_smesher_proto_depIdxs = []int32{
	...
	7,  // 13: spacemesh.v1.SmesherService.SmeshingStatus:input_type -> spacemesh.v1.SmeshingStatusRequest
	...
	19, // 25: spacemesh.v1.SmesherService.PostSetupComputeProviders:output_type -> spacemesh.v1.PostSetupComputeProvidersResponse
	20, // 26: spacemesh.v1.SmesherService.PostConfig:output_type -> spacemesh.v1.PostConfigResponse
	21, // 27: spacemesh.v1.SmesherService.SmeshingStatus:output_type -> spacemesh.v1.SmeshingStatusResponse
...
type SmesherServiceClient interface {
	...
	// Returns info about requested epochs.
	SmeshingStatus(ctx context.Context, in *SmeshingStatusRequest, opts ...grpc.CallOption) (*SmeshingStatusResponse, error)
}
...
func (c *smesherServiceClient) SmeshingStatus(ctx context.Context, in *SmeshingStatusRequest, opts ...grpc.CallOption) (*SmeshingStatusResponse, error) {
...
type SmesherServiceServer interface {
	...
	// Returns info about requested epochs.
	SmeshingStatus(context.Context, *SmeshingStatusRequest) (*SmeshingStatusResponse, error)
}
...
func (*UnimplementedSmesherServiceServer) SmeshingStatus(context.Context, *SmeshingStatusRequest) (*SmeshingStatusResponse, error) {
...
func _SmesherService_SmeshingStatus_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(SmesherServiceServer).SmeshingStatus(ctx, req.(*SmeshingStatusRequest))
	}
	return interceptor(ctx, in, info, handler)
}
