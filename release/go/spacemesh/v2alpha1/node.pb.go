...
const file_spacemesh_v2alpha1_node_proto_rawDesc = "" +
	"\n" +
	"\x1dspacemesh/v2alpha1/node.proto\x12\x12spacemesh.v2alpha1\x1a\x1bgoogle/api/visibility.proto\"\x93\x03\n" +
	"\x12NodeStatusResponse\x12'\n" +
	"\x0fconnected_peers\x18\x01 \x01(\x04R\x0econnectedPeers\x12I\n" +
	"\x06status\x18\x02 \x01(\x0e21.spacemesh.v2alpha1.NodeStatusResponse.SyncStatusR\x06status\x12!\n" +
	...
	"\x11NodeStatusRequest2r\n" +
	"\vNodeService\x12W\n" +
	"\x06Status\x12%.spacemesh.v2alpha1.NodeStatusRequest\x1a&.spacemesh.v2alpha1.NodeStatusResponse\x1a\n" +
	"\xfa\xd2\xe4\x93\x02\x04\x12\x02V2B\xd8\x01\n" +
	"\x16com.spacemesh.v2alpha1B\tNodeProtoP\x01ZJgithub.com/spacemeshos/api/release/go/spacemesh/v2alpha1;spacemeshv2alpha1\xa2\x02\x03SXX\xaa\x02\x12Spacemesh.V2alpha1\xca\x02\x12Spacemesh\\V2alpha1\xe2\x02\x1eSpacemesh\\V2alpha1\\GPBMetadata\xea\x02\x13Spacemesh::V2alpha1b\x06proto3"

var (
	file_spacemesh_v2alpha1_node_proto_rawDescOnce sync.Once
	file_spacemesh_v2alpha1_node_proto_rawDescData []byte
)

func file_spacemesh_v2alpha1_node_proto_rawDescGZIP() []byte {
	file_spacemesh_v2alpha1_node_proto_rawDescOnce.Do(func() {
		file_spacemesh_v2alpha1_node_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_spacemesh_v2alpha1_node_proto_rawDesc), len(file_spacemesh_v2alpha1_node_proto_rawDesc)))
	})
...
var file_spacemesh_v2alpha1_node_proto_goTypes = []any{
...
func file_spacemesh_v2alpha1_node_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_spacemesh_v2alpha1_node_proto_rawDesc), len(file_spacemesh_v2alpha1_node_proto_rawDesc)),
			NumEnums:      1,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   1,
