...
var file_spacemesh_v2beta1_layer_proto_rawDesc = []byte{
	...
	0x68, 0x61, 0x31, 0x2f, 0x6c, 0x61, 0x79, 0x65, 0x72, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x32,
	0x63, 0x0a, 0x0c, 0x4c, 0x61, 0x79, 0x65, 0x72, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x12,
	0x47, 0x0a, 0x04, 0x4c, 0x69, 0x73, 0x74, 0x12, 0x20, 0x2e, 0x73, 0x70, 0x61, 0x63, 0x65, 0x6d,
	0x65, 0x73, 0x68, 0x2e, 0x76, 0x32, 0x61, 0x6c, 0x70, 0x68, 0x61, 0x31, 0x2e, 0x4c, 0x61, 0x79,
	0x65, 0x72, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x1d, 0x2e, 0x73, 0x70, 0x61, 0x63,
	...
	0x12, 0x02, 0x56, 0x32, 0x32, 0x75, 0x0a, 0x12, 0x4c, 0x61, 0x79, 0x65, 0x72, 0x53, 0x74, 0x72,
	...
	0x2e, 0x76, 0x32, 0x61, 0x6c, 0x70, 0x68, 0x61, 0x31, 0x2e, 0x4c, 0x61, 0x79, 0x65, 0x72, 0x53,
...
var file_spacemesh_v2beta1_layer_proto_goTypes = []interface{}{
	(*v2alpha1.LayerRequest)(nil),       // 0: spacemesh.v2alpha1.LayerRequest
	(*v2alpha1.LayerStreamRequest)(nil), // 1: spacemesh.v2alpha1.LayerStreamRequest
	(*v2alpha1.LayerList)(nil),          // 2: spacemesh.v2alpha1.LayerList
	(*v2alpha1.Layer)(nil),              // 3: spacemesh.v2alpha1.Layer
}
var file_spacemesh_v2beta1_layer_proto_depIdxs = []int32{
	0, // 0: spacemesh.v2beta1.LayerService.List:input_type -> spacemesh.v2alpha1.LayerRequest
	1, // 1: spacemesh.v2beta1.LayerStreamService.Stream:input_type -> spacemesh.v2alpha1.LayerStreamRequest
	2, // 2: spacemesh.v2beta1.LayerService.List:output_type -> spacemesh.v2alpha1.LayerList
	3, // 3: spacemesh.v2beta1.LayerStreamService.Stream:output_type -> spacemesh.v2alpha1.Layer
