...
var file_spacemesh_v1_smesher_proto_rawDesc = []byte{
	...
	0x04, 0x47, 0x70, 0x75, 0x73, 0x12, 0x16, 0x2e, 0x67, 0x6f, 0x6f, 0x67, 0x6c, 0x65, 0x2e, 0x70,
	0x72, 0x6f, 0x74, 0x6f, 0x62, 0x75, 0x66, 0x2e, 0x45, 0x6d, 0x70, 0x74, 0x79, 0x1a, 0x1a, 0x2e,
	0x73, 0x70, 0x61, 0x63, 0x65, 0x6d, 0x65, 0x73, 0x68, 0x2e, 0x76, 0x31, 0x2e, 0x47, 0x70, 0x75,
...
var file_spacemesh_v1_smesher_proto_goTypes = []interface{}{
	...
	(*GpusResponse)(nil),                           // 15: spacemesh.v1.GpusResponse
...
var file_spacemesh_v1_smesher_proto_depIdxs = []int32{
	...
	0,  // 9: spacemesh.v1.SmesherService.Gpus:input_type -> google.protobuf.Empty
	...
	15, // 22: spacemesh.v1.SmesherService.Gpus:output_type -> spacemesh.v1.GpusResponse
...
type SmesherServiceClient interface {
	...
	// Returns a list of available gpus for post init
	Gpus(ctx context.Context, in *empty.Empty, opts ...grpc.CallOption) (*GpusResponse, error)
...
func (c *smesherServiceClient) Gpus(ctx context.Context, in *empty.Empty, opts ...grpc.CallOption) (*GpusResponse, error) {
	out := new(GpusResponse)
	err := c.cc.Invoke(ctx, "/spacemesh.v1.SmesherService/Gpus", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type SmesherServiceServer interface {
	...
	// Returns a list of available gpus for post init
	Gpus(context.Context, *empty.Empty) (*GpusResponse, error)
	// Starts (or continues) a post init phase. Supports resuming a previously
	// started init session, as well as changing post params (e.g., post data size)
	// after initial setup.
	// Returns true if request is accepted by node, false if it fails
...
func (*UnimplementedSmesherServiceServer) Gpus(context.Context, *empty.Empty) (*GpusResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method Gpus not implemented")
}
...
func _SmesherService_Gpus_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(empty.Empty)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(SmesherServiceServer).Gpus(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/spacemesh.v1.SmesherService/Gpus",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(SmesherServiceServer).Gpus(ctx, req.(*empty.Empty))
	}
	return interceptor(ctx, in, info, handler)
}
...
var _SmesherService_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "Gpus",
			Handler:    _SmesherService_Gpus_Handler,
		},
		{
