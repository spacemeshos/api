...
var filter_LayerService_List_0 = &utilities.DoubleArray{Encoding: map[string]int{}, Base: []int(nil), Check: []int(nil)}
...
func request_LayerService_List_0(ctx context.Context, marshaler runtime.Marshaler, client LayerServiceClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	...
	if err := runtime.PopulateQueryParameters(&protoReq, req.Form, filter_LayerService_List_0); err != nil {
		return nil, metadata, status.Errorf(codes.InvalidArgument, "%v", err)
	}
...
func RegisterLayerServiceHandlerServer(ctx context.Context, mux *runtime.ServeMux, server LayerServiceServer) error {
	mux.Handle(http.MethodGet, pattern_LayerService_List_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		ctx, cancel := context.WithCancel(req.Context())
		defer cancel()
		var stream runtime.ServerTransportStream
		ctx = grpc.NewContextWithServerTransportStream(ctx, &stream)
		inboundMarshaler, outboundMarshaler := runtime.MarshalerForRequest(mux, req)
		annotatedContext, err := runtime.AnnotateIncomingContext(ctx, mux, req, "/spacemesh.v2beta1.LayerService/List", runtime.WithHTTPPathPattern("/spacemesh.v2beta1.LayerService/List"))
		if err != nil {
...
func RegisterLayerStreamServiceHandlerServer(ctx context.Context, mux *runtime.ServeMux, server LayerStreamServiceServer) error {
	mux.Handle(http.MethodPost, pattern_LayerStreamService_Stream_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
...
// "LayerServiceClient" to call the correct interceptors. This client ignores the HTTP middlewares.
func RegisterLayerServiceHandlerClient(ctx context.Context, mux *runtime.ServeMux, client LayerServiceClient) error {
	mux.Handle(http.MethodGet, pattern_LayerService_List_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		ctx, cancel := context.WithCancel(req.Context())
		defer cancel()
		inboundMarshaler, outboundMarshaler := runtime.MarshalerForRequest(mux, req)
		annotatedContext, err := runtime.AnnotateContext(ctx, mux, req, "/spacemesh.v2beta1.LayerService/List", runtime.WithHTTPPathPattern("/spacemesh.v2beta1.LayerService/List"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
...
var (
	pattern_LayerService_List_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1}, []string{"spacemesh.v2beta1.LayerService", "List"}, ""))
)
...
// doesn't go through the normal gRPC flow (creating a gRPC client etc.) then it will be up to the passed in
// "LayerStreamServiceClient" to call the correct interceptors. This client ignores the HTTP middlewares.
func RegisterLayerStreamServiceHandlerClient(ctx context.Context, mux *runtime.ServeMux, client LayerStreamServiceClient) error {
	mux.Handle(http.MethodPost, pattern_LayerStreamService_Stream_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		defer cancel()
		inboundMarshaler, outboundMarshaler := runtime.MarshalerForRequest(mux, req)
		annotatedContext, err := runtime.AnnotateContext(ctx, mux, req, "/spacemesh.v2beta1.LayerStreamService/Stream", runtime.WithHTTPPathPattern("/spacemesh.v2beta1.LayerStreamService/Stream"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
...
var (
	pattern_LayerStreamService_Stream_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1}, []string{"spacemesh.v2beta1.LayerStreamService", "Stream"}, ""))
)
