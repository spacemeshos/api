...
var file_spacemesh_v1_node_proto_rawDesc = []byte{
	...
	0x6f, 0x74, 0x6f, 0x32, 0xbf, 0x05, 0x0a, 0x0b, 0x4e, 0x6f, 0x64, 0x65, 0x53, 0x65, 0x72, 0x76,
	...
	,
...
var file_spacemesh_v1_node_proto_goTypes = []interface{}{
	...
	(*UpdatePoetServersRequest)(nil),  // 5: spacemesh.v1.UpdatePoetServersRequest
	...
	(*UpdatePoetServersResponse)(nil), // 14: spacemesh.v1.UpdatePoetServersResponse
...
var file_spacemesh_v1_node_proto_depIdxs = []int32{
	...
	5,  // 6: spacemesh.v1.NodeService.UpdatePoetServers:input_type -> spacemesh.v1.UpdatePoetServersRequest
	...
	14, // 15: spacemesh.v1.NodeService.UpdatePoetServers:output_type -> spacemesh.v1.UpdatePoetServersResponse
...
func (c *nodeServiceClient) UpdatePoetServers(ctx context.Context, in *UpdatePoetServersRequest, opts ...grpc.CallOption) (*UpdatePoetServersResponse, error) {
	out := new(UpdatePoetServersResponse)
	err := c.cc.Invoke(ctx, "/spacemesh.v1.NodeService/UpdatePoetServers", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (*UnimplementedNodeServiceServer) UpdatePoetServers(context.Context, *UpdatePoetServersRequest) (*UpdatePoetServersResponse, error) {
...
func _NodeService_UpdatePoetServers_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(UpdatePoetServersRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(NodeServiceServer).UpdatePoetServers(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/spacemesh.v1.NodeService/UpdatePoetServers",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(NodeServiceServer).UpdatePoetServers(ctx, req.(*UpdatePoetServersRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var _NodeService_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _NodeService_UpdatePoetServers_Handler,
		},
	},
