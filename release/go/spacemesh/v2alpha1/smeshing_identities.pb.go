...
type IdentityStatesRequest struct {
	...
	States []v2beta1.IdentityState `protobuf:"varint,1,rep,packed,name=states,proto3,enum=spacemesh.v2beta1.IdentityState" json:"states,omitempty"` // list of identity states to filter by
...
func (x *IdentityStatesRequest) GetStates() []v2beta1.IdentityState {
	if x != nil {
		return x.States
	}
	return nil
...
type IdentityStatesResponse struct {
	...
	Identities map[string]*v2beta1.Identity `protobuf:"bytes,1,rep,name=identities,proto3" json:"identities,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
}
...
func (x *IdentityStatesResponse) GetIdentities() map[string]*v2beta1.Identity {
	if x != nil {
		return x.Identities
	}
	return nil
...
type PoetInfoResponse struct {
	...
	Config *v2beta1.PoetConfig `protobuf:"bytes,2,opt,name=config,proto3" json:"config,omitempty"`
}
...
func (x *PoetInfoResponse) GetConfig() *v2beta1.PoetConfig {
	if x != nil {
		return x.Config
	}
	return nil
...
type EligibilitiesResponse struct {
	...
	Identities map[string]*v2beta1.EpochEligibilities `protobuf:"bytes,1,rep,name=identities,proto3" json:"identities,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
}
...
func (x *EligibilitiesResponse) GetIdentities() map[string]*v2beta1.EpochEligibilities {
	if x != nil {
		return x.Identities
	}
	return nil
...
type ProposalsResponse struct {
	...
	Proposals map[string]*v2beta1.Proposals `protobuf:"bytes,1,rep,name=proposals,proto3" json:"proposals,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
}
...
func (x *ProposalsResponse) GetProposals() map[string]*v2beta1.Proposals {
	if x != nil {
		return x.Proposals
	}
	return nil
...
var file_spacemesh_v2alpha1_smeshing_identities_proto_rawDesc = []byte{
	...
	,
	...
	0x28, 0x04, 0x52, 0x05, 0x6c, 0x69, 0x6d, 0x69, 0x74, 0x22, 0xd0, 0x01, 0x0a, 0x16, 0x49, 0x64,
	...
	0x1a, 0x5a, 0x0a, 0x0f, 0x49, 0x64, 0x65, 0x6e, 0x74, 0x69, 0x74, 0x69, 0x65, 0x73, 0x45, 0x6e,
	...
	0x5f, 0x0a, 0x10, 0x50, 0x6f, 0x65, 0x74, 0x49, 0x6e, 0x66, 0x6f, 0x52, 0x65, 0x73, 0x70, 0x6f,
	0x6e, 0x73, 0x65, 0x12, 0x14, 0x0a, 0x05, 0x70, 0x6f, 0x65, 0x74, 0x73, 0x18, 0x01, 0x20, 0x03,
	0x28, 0x09, 0x52, 0x05, 0x70, 0x6f, 0x65, 0x74, 0x73, 0x12, 0x35, 0x0a, 0x06, 0x63, 0x6f, 0x6e,
	0x66, 0x69, 0x67, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x1d, 0x2e, 0x73, 0x70, 0x61, 0x63,
	...
	0x73, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x22, 0xd8, 0x01, 0x0a, 0x15, 0x45, 0x6c, 0x69,
	0x67, 0x69, 0x62, 0x69, 0x6c, 0x69, 0x74, 0x69, 0x65, 0x73, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e,
	0x73, 0x65, 0x12, 0x59, 0x0a, 0x0a, 0x69, 0x64, 0x65, 0x6e, 0x74, 0x69, 0x74, 0x69, 0x65, 0x73,
	0x18, 0x01, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x39, 0x2e, 0x73, 0x70, 0x61, 0x63, 0x65, 0x6d, 0x65,
	...
	0x65, 0x2e, 0x49, 0x64, 0x65, 0x6e, 0x74, 0x69, 0x74, 0x69, 0x65, 0x73, 0x45, 0x6e, 0x74, 0x72,
	0x79, 0x52, 0x0a, 0x69, 0x64, 0x65, 0x6e, 0x74, 0x69, 0x74, 0x69, 0x65, 0x73, 0x1a, 0x64, 0x0a,
	...
	0x62, 0x65, 0x74, 0x61, 0x31, 0x2e, 0x45, 0x70, 0x6f, 0x63, 0x68, 0x45, 0x6c, 0x69, 0x67, 0x69,
	0x62, 0x69, 0x6c, 0x69, 0x74, 0x69, 0x65, 0x73, 0x52, 0x05, 0x76, 0x61, 0x6c, 0x75, 0x65, 0x3a,
	0x02, 0x38, 0x01, 0x22, 0x12, 0x0a, 0x10, 0x50, 0x72, 0x6f, 0x70, 0x6f, 0x73, 0x61, 0x6c, 0x73,
	0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x22, 0xc3, 0x01, 0x0a, 0x11, 0x50, 0x72, 0x6f, 0x70,
	...
	0x6c, 0x73, 0x52, 0x05, 0x76, 0x61, 0x6c, 0x75, 0x65, 0x3a, 0x02, 0x38, 0x01, 0x32, 0xa5, 0x03,
	0x0a, 0x19, 0x53, 0x6d, 0x65, 0x73, 0x68, 0x69, 0x6e, 0x67, 0x49, 0x64, 0x65, 0x6e, 0x74, 0x69,
	0x74, 0x69, 0x65, 0x73, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x12, 0x5f, 0x0a, 0x06, 0x53,
	0x74, 0x61, 0x74, 0x65, 0x73, 0x12, 0x29, 0x2e, 0x73, 0x70, 0x61, 0x63, 0x65, 0x6d, 0x65, 0x73,
	...
	0x1a, 0x2a, 0x2e, 0x73, 0x70, 0x61, 0x63, 0x65, 0x6d, 0x65, 0x73, 0x68, 0x2e, 0x76, 0x32, 0x61,
	0x6c, 0x70, 0x68, 0x61, 0x31, 0x2e, 0x49, 0x64, 0x65, 0x6e, 0x74, 0x69, 0x74, 0x79, 0x53, 0x74,
	0x61, 0x74, 0x65, 0x73, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x55, 0x0a, 0x08,
	...
	0x6e, 0x73, 0x65, 0x12, 0x64, 0x0a, 0x0d, 0x45, 0x6c, 0x69, 0x67, 0x69, 0x62, 0x69, 0x6c, 0x69,
	0x74, 0x69, 0x65, 0x73, 0x12, 0x28, 0x2e, 0x73, 0x70, 0x61, 0x63, 0x65, 0x6d, 0x65, 0x73, 0x68,
	...
	0x73, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x58, 0x0a, 0x09, 0x50, 0x72, 0x6f,
	...
	0x6e, 0x73, 0x65, 0x1a, 0x10, 0xfa, 0xd2, 0xe4, 0x93, 0x02, 0x0a, 0x12, 0x08, 0x49, 0x4e, 0x54,
	0x45, 0x52, 0x4e, 0x41, 0x4c, 0x42, 0xe6, 0x01, 0x0a, 0x16, 0x63, 0x6f, 0x6d, 0x2e, 0x73, 0x70,
...
var file_spacemesh_v2alpha1_smeshing_identities_proto_msgTypes = make([]protoimpl.MessageInfo, 11)
var file_spacemesh_v2alpha1_smeshing_identities_proto_goTypes = []interface{}{
	(*IdentityStatesRequest)(nil),      // 0: spacemesh.v2alpha1.IdentityStatesRequest
	(*IdentityStatesResponse)(nil),     // 1: spacemesh.v2alpha1.IdentityStatesResponse
	(*PoetInfoRequest)(nil),            // 2: spacemesh.v2alpha1.PoetInfoRequest
	(*PoetInfoResponse)(nil),           // 3: spacemesh.v2alpha1.PoetInfoResponse
	(*EligibilitiesRequest)(nil),       // 4: spacemesh.v2alpha1.EligibilitiesRequest
	(*EligibilitiesResponse)(nil),      // 5: spacemesh.v2alpha1.EligibilitiesResponse
	(*ProposalsRequest)(nil),           // 6: spacemesh.v2alpha1.ProposalsRequest
	(*ProposalsResponse)(nil),          // 7: spacemesh.v2alpha1.ProposalsResponse
	nil,                                // 8: spacemesh.v2alpha1.IdentityStatesResponse.IdentitiesEntry
	nil,                                // 9: spacemesh.v2alpha1.EligibilitiesResponse.IdentitiesEntry
	nil,                                // 10: spacemesh.v2alpha1.ProposalsResponse.ProposalsEntry
	(v2beta1.IdentityState)(0),         // 11: spacemesh.v2beta1.IdentityState
	(*v2beta1.PoetConfig)(nil),         // 12: spacemesh.v2beta1.PoetConfig
	(*v2beta1.Identity)(nil),           // 13: spacemesh.v2beta1.Identity
	(*v2beta1.EpochEligibilities)(nil), // 14: spacemesh.v2beta1.EpochEligibilities
	(*v2beta1.Proposals)(nil),          // 15: spacemesh.v2beta1.Proposals
}
var file_spacemesh_v2alpha1_smeshing_identities_proto_depIdxs = []int32{
	11, // 0: spacemesh.v2alpha1.IdentityStatesRequest.states:type_name -> spacemesh.v2beta1.IdentityState
	8,  // 1: spacemesh.v2alpha1.IdentityStatesResponse.identities:type_name -> spacemesh.v2alpha1.IdentityStatesResponse.IdentitiesEntry
	12, // 2: spacemesh.v2alpha1.PoetInfoResponse.config:type_name -> spacemesh.v2beta1.PoetConfig
	9,  // 3: spacemesh.v2alpha1.EligibilitiesResponse.identities:type_name -> spacemesh.v2alpha1.EligibilitiesResponse.IdentitiesEntry
	10, // 4: spacemesh.v2alpha1.ProposalsResponse.proposals:type_name -> spacemesh.v2alpha1.ProposalsResponse.ProposalsEntry
	13, // 5: spacemesh.v2alpha1.IdentityStatesResponse.IdentitiesEntry.value:type_name -> spacemesh.v2beta1.Identity
	14, // 6: spacemesh.v2alpha1.EligibilitiesResponse.IdentitiesEntry.value:type_name -> spacemesh.v2beta1.EpochEligibilities
	15, // 7: spacemesh.v2alpha1.ProposalsResponse.ProposalsEntry.value:type_name -> spacemesh.v2beta1.Proposals
	0,  // 8: spacemesh.v2alpha1.SmeshingIdentitiesService.States:input_type -> spacemesh.v2alpha1.IdentityStatesRequest
	2,  // 9: spacemesh.v2alpha1.SmeshingIdentitiesService.PoetInfo:input_type -> spacemesh.v2alpha1.PoetInfoRequest
	4,  // 10: spacemesh.v2alpha1.SmeshingIdentitiesService.Eligibilities:input_type -> spacemesh.v2alpha1.EligibilitiesRequest
	6,  // 11: spacemesh.v2alpha1.SmeshingIdentitiesService.Proposals:input_type -> spacemesh.v2alpha1.ProposalsRequest
	1,  // 12: spacemesh.v2alpha1.SmeshingIdentitiesService.States:output_type -> spacemesh.v2alpha1.IdentityStatesResponse
	3,  // 13: spacemesh.v2alpha1.SmeshingIdentitiesService.PoetInfo:output_type -> spacemesh.v2alpha1.PoetInfoResponse
	5,  // 14: spacemesh.v2alpha1.SmeshingIdentitiesService.Eligibilities:output_type -> spacemesh.v2alpha1.EligibilitiesResponse
	7,  // 15: spacemesh.v2alpha1.SmeshingIdentitiesService.Proposals:output_type -> spacemesh.v2alpha1.ProposalsResponse
