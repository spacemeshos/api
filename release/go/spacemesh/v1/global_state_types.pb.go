...
const (
	...
	TransactionReceipt_TRANSACTION_RESULT_RUNTIME_EXCEPTION    TransactionReceipt_TransactionResult = 3  // app code execution exception
	...
	TransactionReceipt_TRANSACTION_RESULT_APP_NOT_FOUND        TransactionReceipt_TransactionResult = 6  // an attempt to execute an app where there's no app at the app address
	TransactionReceipt_TRANSACTION_RESULT_FUNC_NOT_FOUND       TransactionReceipt_TransactionResult = 8  // called function not found in app
	TransactionReceipt_TRANSACTION_RESULT_INSTANTIATION_FAILED TransactionReceipt_TransactionResult = 9  // error creating an instance from a template
	TransactionReceipt_TRANSACTION_RESULT_DEPLOY_FAILED        TransactionReceipt_TransactionResult = 10 // error deploying a template to the mesh
)
...
var (
	TransactionReceipt_TransactionResult_name = map[int32]string{
		...
		6:  "TRANSACTION_RESULT_APP_NOT_FOUND",
		8:  "TRANSACTION_RESULT_FUNC_NOT_FOUND",
		9:  "TRANSACTION_RESULT_INSTANTIATION_FAILED",
		10: "TRANSACTION_RESULT_DEPLOY_FAILED",
	}
	TransactionReceipt_TransactionResult_value = map[string]int32{
		...
		"TRANSACTION_RESULT_APP_NOT_FOUND":        6,
		"TRANSACTION_RESULT_FUNC_NOT_FOUND":       8,
		"TRANSACTION_RESULT_INSTANTIATION_FAILED": 9,
		"TRANSACTION_RESULT_DEPLOY_FAILED":        10,
	}
)
...
func (TransactionReceipt_TransactionResult) EnumDescriptor() ([]byte, []int) {
	return file_spacemesh_v1_global_state_types_proto_rawDescGZIP(), []int{10, 0}
}
...
func (x *ExecutionError) GetCode() uint32 {
	if x != nil {
		return x.Code
	}
	return 0
...
// From dev perspective we want to enable something like the following from the higher-level lang or rust code:
// info([enty_name], [entry_text])
// e.g. info("sig_verification", format!("%s : %d", str1, ui64))
type LogEntry struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	LogLevel uint32 `protobuf:"varint,1,opt,name=log_level,json=logLevel,proto3" json:"log_level,omitempty"` // info, debug, trace, error, etc...
	Context  string `protobuf:"bytes,2,opt,name=context,proto3" json:"context,omitempty"`                    // function name e.g. withdraw()
	Name     string `protobuf:"bytes,3,opt,name=name,proto3" json:"name,omitempty"`                          // entry name
	Entry    string `protobuf:"bytes,4,opt,name=entry,proto3" json:"entry,omitempty"`                        // entry printed data
}
...
func (x *LogEntry) GetLogLevel() uint32 {
	if x != nil {
		return x.LogLevel
	}
	return 0
...
func (x *LogEntry) GetContext() string {
	if x != nil {
		return x.Context
	}
	return ""
...
type TransactionReceipt struct {
	...
	SvmData      []byte                               `protobuf:"bytes,7,opt,name=svm_data,json=svmData,proto3" json:"svm_data,omitempty"`                                        // SVM data returned from an SVM function. Needs to be decoded with svm-codec
	AppState     []byte                               `protobuf:"bytes,8,opt,name=app_state,json=appState,proto3" json:"app_state,omitempty"`                                     // when app function executed or app deployed, the app root state hash after execution has completed
	ErrorMessage *ExecutionError                      `protobuf:"bytes,9,opt,name=error_message,json=errorMessage,proto3" json:"error_message,omitempty"`                         // error status and message when result != executed with additional error info
	LogEntries   []*LogEntry                          `protobuf:"bytes,10,rep,name=log_entries,json=logEntries,proto3" json:"log_entries,omitempty"`                              // zero or more ordered log entries generated by svm logging functions
}
...
func (x *TransactionReceipt) GetAppState() []byte {
	if x != nil {
		return x.AppState
	}
	return nil
...
func (x *TransactionReceipt) GetErrorMessage() *ExecutionError {
	if x != nil {
...
func (x *TransactionReceipt) GetLogEntries() []*LogEntry {
	if x != nil {
		return x.LogEntries
	}
	return nil
...
func (x *GlobalStateRoot) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*GlobalStateRoot) ProtoMessage() {}

func (x *GlobalStateRoot) ProtoReflect() protoreflect.Message {
	mi := &file_spacemesh_v1_global_state_types_proto_msgTypes[17]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use GlobalStateRoot.ProtoReflect.Descriptor instead.
func (*GlobalStateRoot) Descriptor() ([]byte, []int) {
	return file_spacemesh_v1_global_state_types_proto_rawDescGZIP(), []int{17}
}

func (x *GlobalStateRoot) GetHash() []byte {
	if x != nil {
		return x.Hash
	}
	return nil
...
func (x *GlobalStateRoot) GetLayer() *LayerNumber {
	if x != nil {
		return x.Layer
	}
	return nil
...
// layer number.
type GlobalStateRootRequest struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
}

func (x *GlobalStateRootRequest) Reset() {
	*x = GlobalStateRootRequest{}
	if protoimpl.UnsafeEnabled {
...
func (x *GlobalStateRootRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*GlobalStateRootRequest) ProtoMessage() {}

func (x *GlobalStateRootRequest) ProtoReflect() protoreflect.Message {
	mi := &file_spacemesh_v1_global_state_types_proto_msgTypes[18]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use GlobalStateRootRequest.ProtoReflect.Descriptor instead.
func (*GlobalStateRootRequest) Descriptor() ([]byte, []int) {
	return file_spacemesh_v1_global_state_types_proto_rawDescGZIP(), []int{18}
}

type GlobalStateRootResponse struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	Response *GlobalStateRoot `protobuf:"bytes,1,opt,name=response,proto3" json:"response,omitempty"`
}

func (x *GlobalStateRootResponse) Reset() {
	*x = GlobalStateRootResponse{}
	if protoimpl.UnsafeEnabled {
...
func (x *GlobalStateRootResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*GlobalStateRootResponse) ProtoMessage() {}

func (x *GlobalStateRootResponse) ProtoReflect() protoreflect.Message {
	mi := &file_spacemesh_v1_global_state_types_proto_msgTypes[19]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use GlobalStateRootResponse.ProtoReflect.Descriptor instead.
func (*GlobalStateRootResponse) Descriptor() ([]byte, []int) {
	return file_spacemesh_v1_global_state_types_proto_rawDescGZIP(), []int{19}
}

func (x *GlobalStateRootResponse) GetResponse() *GlobalStateRoot {
	if x != nil {
		return x.Response
	}
	return nil
...
func (x *GlobalStateData) GetGlobalState() *GlobalStateRoot {
...
type GlobalStateData_GlobalState struct {
	GlobalState *GlobalStateRoot `protobuf:"bytes,4,opt,name=global_state,json=globalState,proto3,oneof"`
}
...
func (x *AppEventStreamRequest) Reset() {
	*x = AppEventStreamRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_spacemesh_v1_global_state_types_proto_msgTypes[23]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*AppEventStreamRequest) Descriptor() ([]byte, []int) {
	return file_spacemesh_v1_global_state_types_proto_rawDescGZIP(), []int{23}
}
...
func (x *AppEventStreamResponse) Reset() {
	*x = AppEventStreamResponse{}
	if protoimpl.UnsafeEnabled {
		mi := &file_spacemesh_v1_global_state_types_proto_msgTypes[24]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*AppEventStreamResponse) Descriptor() ([]byte, []int) {
	return file_spacemesh_v1_global_state_types_proto_rawDescGZIP(), []int{24}
}
...
var file_spacemesh_v1_global_state_types_proto_rawDesc = []byte{
	...
	0x20, 0x01, 0x28, 0x0d, 0x52, 0x06, 0x6f, 0x66, 0x66, 0x73, 0x65, 0x74, 0x22, 0x3e, 0x0a, 0x0e,
	...
	,
	...
	0x73, 0x61, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x49, 0x64, 0x52, 0x02, 0x69, 0x64, 0x12, 0x4a, 0x0a,
	0x06, 0x72, 0x65, 0x73, 0x75, 0x6c, 0x74, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x32, 0x2e,
	...
	,
	...
	0x0a, 0x0b, 0x6c, 0x6f, 0x67, 0x5f, 0x65, 0x6e, 0x74, 0x72, 0x69, 0x65, 0x73, 0x18, 0x0a, 0x20,
	...
	0x45, 0x6e, 0x74, 0x72, 0x69, 0x65, 0x73, 0x22, 0x9a, 0x03, 0x0a, 0x11, 0x54, 0x72, 0x61, 0x6e,
	0x73, 0x61, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x52, 0x65, 0x73, 0x75, 0x6c, 0x74, 0x12, 0x22, 0x0a,
	0x1e, 0x54, 0x52, 0x41, 0x4e, 0x53, 0x41, 0x43, 0x54, 0x49, 0x4f, 0x4e, 0x5f, 0x52, 0x45, 0x53,
	...
	0x5f, 0x52, 0x45, 0x53, 0x55, 0x4c, 0x54, 0x5f, 0x45, 0x58, 0x45, 0x43, 0x55, 0x54, 0x45, 0x44,
	0x10, 0x01, 0x12, 0x22, 0x0a, 0x1e, 0x54, 0x52, 0x41, 0x4e, 0x53, 0x41, 0x43, 0x54, 0x49, 0x4f,
	0x4e, 0x5f, 0x52, 0x45, 0x53, 0x55, 0x4c, 0x54, 0x5f, 0x42, 0x41, 0x44, 0x5f, 0x43, 0x4f, 0x55,
	0x4e, 0x54, 0x45, 0x52, 0x10, 0x02, 0x12, 0x28, 0x0a, 0x24, 0x54, 0x52, 0x41, 0x4e, 0x53, 0x41,
	0x43, 0x54, 0x49, 0x4f, 0x4e, 0x5f, 0x52, 0x45, 0x53, 0x55, 0x4c, 0x54, 0x5f, 0x52, 0x55, 0x4e,
	0x54, 0x49, 0x4d, 0x45, 0x5f, 0x45, 0x58, 0x43, 0x45, 0x50, 0x54, 0x49, 0x4f, 0x4e, 0x10, 0x03,
	...
	0x45, 0x4e, 0x54, 0x5f, 0x47, 0x41, 0x53, 0x10, 0x04, 0x12, 0x29, 0x0a, 0x25, 0x54, 0x52, 0x41,
	...
	,
	...
	0x70, 0x74, 0x12, 0x40, 0x0a, 0x0f, 0x61, 0x63, 0x63, 0x6f, 0x75, 0x6e, 0x74, 0x5f, 0x77, 0x72,
	0x61, 0x70, 0x70, 0x65, 0x72, 0x18, 0x03, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x15, 0x2e, 0x73, 0x70,
	0x61, 0x63, 0x65, 0x6d, 0x65, 0x73, 0x68, 0x2e, 0x76, 0x31, 0x2e, 0x41, 0x63, 0x63, 0x6f, 0x75,
	0x6e, 0x74, 0x48, 0x00, 0x52, 0x0e, 0x61, 0x63, 0x63, 0x6f, 0x75, 0x6e, 0x74, 0x57, 0x72, 0x61,
	0x70, 0x70, 0x65, 0x72, 0x42, 0x07, 0x0a, 0x05, 0x64, 0x61, 0x74, 0x75, 0x6d, 0x22, 0x7d, 0x0a,
	0x18, 0x41, 0x63, 0x63, 0x6f, 0x75, 0x6e, 0x74, 0x44, 0x61, 0x74, 0x61, 0x51, 0x75, 0x65, 0x72,
	0x79, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x23, 0x0a, 0x0d, 0x74, 0x6f, 0x74,
	...
	0x0a, 0x0c, 0x61, 0x63, 0x63, 0x6f, 0x75, 0x6e, 0x74, 0x5f, 0x69, 0x74, 0x65, 0x6d, 0x18, 0x02,
	0x20, 0x03, 0x28, 0x0b, 0x32, 0x19, 0x2e, 0x73, 0x70, 0x61, 0x63, 0x65, 0x6d, 0x65, 0x73, 0x68,
	0x2e, 0x76, 0x31, 0x2e, 0x41, 0x63, 0x63, 0x6f, 0x75, 0x6e, 0x74, 0x44, 0x61, 0x74, 0x61, 0x52,
	0x0b, 0x61, 0x63, 0x63, 0x6f, 0x75, 0x6e, 0x74, 0x49, 0x74, 0x65, 0x6d, 0x22, 0x45, 0x0a, 0x1a,
	0x53, 0x6d, 0x65, 0x73, 0x68, 0x65, 0x72, 0x52, 0x65, 0x77, 0x61, 0x72, 0x64, 0x53, 0x74, 0x72,
	0x65, 0x61, 0x6d, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x27, 0x0a, 0x02, 0x69, 0x64,
	...
	,
	...
	,
	...
	0x05, 0x6c, 0x61, 0x79, 0x65, 0x72, 0x22, 0x18, 0x0a, 0x16, 0x47, 0x6c, 0x6f, 0x62, 0x61, 0x6c,
	0x53, 0x74, 0x61, 0x74, 0x65, 0x52, 0x6f, 0x6f, 0x74, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74,
	0x22, 0x54, 0x0a, 0x17, 0x47, 0x6c, 0x6f, 0x62, 0x61, 0x6c, 0x53, 0x74, 0x61, 0x74, 0x65, 0x52,
	0x6f, 0x6f, 0x74, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x39, 0x0a, 0x08, 0x72,
	...
	,
	...
	0x65, 0x44, 0x61, 0x74, 0x61, 0x52, 0x05, 0x64, 0x61, 0x74, 0x75, 0x6d, 0x22, 0x17, 0x0a, 0x15,
	0x41, 0x70, 0x70, 0x45, 0x76, 0x65, 0x6e, 0x74, 0x53, 0x74, 0x72, 0x65, 0x61, 0x6d, 0x52, 0x65,
	0x71, 0x75, 0x65, 0x73, 0x74, 0x22, 0x46, 0x0a, 0x16, 0x41, 0x70, 0x70, 0x45, 0x76, 0x65, 0x6e,
	...
	0x70, 0x45, 0x76, 0x65, 0x6e, 0x74, 0x52, 0x05, 0x65, 0x76, 0x65, 0x6e, 0x74, 0x2a, 0x9c, 0x01,
	0x0a, 0x0f, 0x41, 0x63, 0x63, 0x6f, 0x75, 0x6e, 0x74, 0x44, 0x61, 0x74, 0x61, 0x46, 0x6c, 0x61,
	0x67, 0x12, 0x21, 0x0a, 0x1d, 0x41, 0x43, 0x43, 0x4f, 0x55, 0x4e, 0x54, 0x5f, 0x44, 0x41, 0x54,
	0x41, 0x5f, 0x46, 0x4c, 0x41, 0x47, 0x5f, 0x55, 0x4e, 0x53, 0x50, 0x45, 0x43, 0x49, 0x46, 0x49,
	0x45, 0x44, 0x10, 0x00, 0x12, 0x29, 0x0a, 0x25, 0x41, 0x43, 0x43, 0x4f, 0x55, 0x4e, 0x54, 0x5f,
	...
	,
...
var file_spacemesh_v1_global_state_types_proto_msgTypes = make([]protoimpl.MessageInfo, 25)
var file_spacemesh_v1_global_state_types_proto_goTypes = []interface{}{
	...
	(*ExecutionError)(nil),                    // 11: spacemesh.v1.ExecutionError
	(*LogEntry)(nil),                          // 12: spacemesh.v1.LogEntry
	(*TransactionReceipt)(nil),                // 13: spacemesh.v1.TransactionReceipt
	(*AccountData)(nil),                       // 14: spacemesh.v1.AccountData
	(*AccountDataQueryResponse)(nil),          // 15: spacemesh.v1.AccountDataQueryResponse
	(*SmesherRewardStreamRequest)(nil),        // 16: spacemesh.v1.SmesherRewardStreamRequest
	(*SmesherRewardStreamResponse)(nil),       // 17: spacemesh.v1.SmesherRewardStreamResponse
	(*SmesherDataQueryRequest)(nil),           // 18: spacemesh.v1.SmesherDataQueryRequest
	(*SmesherDataQueryResponse)(nil),          // 19: spacemesh.v1.SmesherDataQueryResponse
	(*GlobalStateRoot)(nil),                   // 20: spacemesh.v1.GlobalStateRoot
	(*GlobalStateRootRequest)(nil),            // 21: spacemesh.v1.GlobalStateRootRequest
	(*GlobalStateRootResponse)(nil),           // 22: spacemesh.v1.GlobalStateRootResponse
	(*GlobalStateStreamRequest)(nil),          // 23: spacemesh.v1.GlobalStateStreamRequest
	(*GlobalStateData)(nil),                   // 24: spacemesh.v1.GlobalStateData
	(*GlobalStateStreamResponse)(nil),         // 25: spacemesh.v1.GlobalStateStreamResponse
	(*AppEventStreamRequest)(nil),             // 26: spacemesh.v1.AppEventStreamRequest
	(*AppEventStreamResponse)(nil),            // 27: spacemesh.v1.AppEventStreamResponse
	(*Amount)(nil),                            // 28: spacemesh.v1.Amount
	(*AccountId)(nil),                         // 29: spacemesh.v1.AccountId
	(*TransactionId)(nil),                     // 30: spacemesh.v1.TransactionId
	(*LayerNumber)(nil),                       // 31: spacemesh.v1.LayerNumber
	(*Reward)(nil),                            // 32: spacemesh.v1.Reward
	(*SmesherId)(nil),                         // 33: spacemesh.v1.SmesherId
	(*AppEvent)(nil),                          // 34: spacemesh.v1.AppEvent
}
var file_spacemesh_v1_global_state_types_proto_depIdxs = []int32{
	28, // 0: spacemesh.v1.AccountState.balance:type_name -> spacemesh.v1.Amount
	29, // 1: spacemesh.v1.Account.account_id:type_name -> spacemesh.v1.AccountId
	...
	29, // 4: spacemesh.v1.AccountRequest.account_id:type_name -> spacemesh.v1.AccountId
	4,  // 5: spacemesh.v1.AccountResponse.account_wrapper:type_name -> spacemesh.v1.Account
	29, // 6: spacemesh.v1.AccountDataFilter.account_id:type_name -> spacemesh.v1.AccountId
	7,  // 7: spacemesh.v1.AccountDataStreamRequest.filter:type_name -> spacemesh.v1.AccountDataFilter
	14, // 8: spacemesh.v1.AccountDataStreamResponse.datum:type_name -> spacemesh.v1.AccountData
	7,  // 9: spacemesh.v1.AccountDataQueryRequest.filter:type_name -> spacemesh.v1.AccountDataFilter
	30, // 10: spacemesh.v1.TransactionReceipt.id:type_name -> spacemesh.v1.TransactionId
	2,  // 11: spacemesh.v1.TransactionReceipt.result:type_name -> spacemesh.v1.TransactionReceipt.TransactionResult
	28, // 12: spacemesh.v1.TransactionReceipt.fee:type_name -> spacemesh.v1.Amount
	31, // 13: spacemesh.v1.TransactionReceipt.layer:type_name -> spacemesh.v1.LayerNumber
	11, // 14: spacemesh.v1.TransactionReceipt.error_message:type_name -> spacemesh.v1.ExecutionError
	12, // 15: spacemesh.v1.TransactionReceipt.log_entries:type_name -> spacemesh.v1.LogEntry
	32, // 16: spacemesh.v1.AccountData.reward:type_name -> spacemesh.v1.Reward
	13, // 17: spacemesh.v1.AccountData.receipt:type_name -> spacemesh.v1.TransactionReceipt
	4,  // 18: spacemesh.v1.AccountData.account_wrapper:type_name -> spacemesh.v1.Account
	14, // 19: spacemesh.v1.AccountDataQueryResponse.account_item:type_name -> spacemesh.v1.AccountData
	33, // 20: spacemesh.v1.SmesherRewardStreamRequest.id:type_name -> spacemesh.v1.SmesherId
	32, // 21: spacemesh.v1.SmesherRewardStreamResponse.reward:type_name -> spacemesh.v1.Reward
	33, // 22: spacemesh.v1.SmesherDataQueryRequest.smesher_id:type_name -> spacemesh.v1.SmesherId
	32, // 23: spacemesh.v1.SmesherDataQueryResponse.rewards:type_name -> spacemesh.v1.Reward
	31, // 24: spacemesh.v1.GlobalStateRoot.layer:type_name -> spacemesh.v1.LayerNumber
	20, // 25: spacemesh.v1.GlobalStateRootResponse.response:type_name -> spacemesh.v1.GlobalStateRoot
	32, // 26: spacemesh.v1.GlobalStateData.reward:type_name -> spacemesh.v1.Reward
	13, // 27: spacemesh.v1.GlobalStateData.receipt:type_name -> spacemesh.v1.TransactionReceipt
	4,  // 28: spacemesh.v1.GlobalStateData.account_wrapper:type_name -> spacemesh.v1.Account
	20, // 29: spacemesh.v1.GlobalStateData.global_state:type_name -> spacemesh.v1.GlobalStateRoot
	24, // 30: spacemesh.v1.GlobalStateStreamResponse.datum:type_name -> spacemesh.v1.GlobalStateData
	34, // 31: spacemesh.v1.AppEventStreamResponse.event:type_name -> spacemesh.v1.AppEvent
...
func file_spacemesh_v1_global_state_types_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_spacemesh_v1_global_state_types_proto_msgTypes[18].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*GlobalStateRootRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_spacemesh_v1_global_state_types_proto_msgTypes[19].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*GlobalStateRootResponse); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_spacemesh_v1_global_state_types_proto_msgTypes[23].Exporter = func(v interface{}, i int) interface{} {
		...
		file_spacemesh_v1_global_state_types_proto_msgTypes[24].Exporter = func(v interface{}, i int) interface{} {
	...
	file_spacemesh_v1_global_state_types_proto_msgTypes[11].OneofWrappers = []interface{}{
		(*AccountData_Reward)(nil),
		(*AccountData_Receipt)(nil),
		(*AccountData_AccountWrapper)(nil),
	}
	file_spacemesh_v1_global_state_types_proto_msgTypes[21].OneofWrappers = []interface{}{
