...
var file_spacemesh_v1_debug_proto_rawDesc = []byte{
	...
	0x2e, 0x76, 0x31, 0x2e, 0x50, 0x72, 0x6f, 0x70, 0x6f, 0x73, 0x61, 0x6c, 0x30, 0x01, 0x42, 0x34,
...
func (c *debugServiceClient) ActiveSet(ctx context.Context, in *ActiveSetRequest, opts ...grpc.CallOption) (*ActiveSetResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/spacemesh.v1.DebugService/ActiveSet", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _DebugService_ActiveSet_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/spacemesh.v1.DebugService/ActiveSet",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
