...
const file_spacemesh_v2alpha1_network_proto_rawDesc = "" +
	"\n" +
	" spacemesh/v2alpha1/network.proto\x12\x12spacemesh.v2alpha1\x1a\x1fgoogle/protobuf/timestamp.proto\x1a\x1egoogle/protobuf/duration.proto\x1a\x1bgoogle/api/visibility.proto\"\xd1\x02\n" +
	...
	"\x12NetworkInfoRequest2u\n" +
	"\x0eNetworkService\x12W\n" +
	"\x04Info\x12&.spacemesh.v2alpha1.NetworkInfoRequest\x1a'.spacemesh.v2alpha1.NetworkInfoResponse\x1a\n" +
	"\xfa\xd2\xe4\x93\x02\x04\x12\x02V2B\xdb\x01\n" +
	"\x16com.spacemesh.v2alpha1B\fNetworkProtoP\x01ZJgithub.com/spacemeshos/api/release/go/spacemesh/v2alpha1;spacemeshv2alpha1\xa2\x02\x03SXX\xaa\x02\x12Spacemesh.V2alpha1\xca\x02\x12Spacemesh\\V2alpha1\xe2\x02\x1eSpacemesh\\V2alpha1\\GPBMetadata\xea\x02\x13Spacemesh::V2alpha1b\x06proto3"

var (
	file_spacemesh_v2alpha1_network_proto_rawDescOnce sync.Once
	file_spacemesh_v2alpha1_network_proto_rawDescData []byte
)

func file_spacemesh_v2alpha1_network_proto_rawDescGZIP() []byte {
	file_spacemesh_v2alpha1_network_proto_rawDescOnce.Do(func() {
		file_spacemesh_v2alpha1_network_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_spacemesh_v2alpha1_network_proto_rawDesc), len(file_spacemesh_v2alpha1_network_proto_rawDesc)))
	})
...
var file_spacemesh_v2alpha1_network_proto_goTypes = []any{
...
func file_spacemesh_v2alpha1_network_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_spacemesh_v2alpha1_network_proto_rawDesc), len(file_spacemesh_v2alpha1_network_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   1,
