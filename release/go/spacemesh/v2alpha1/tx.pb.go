...
type TransactionList struct {
	...
	Total        uint64                 `protobuf:"varint,2,opt,name=total,proto3" json:"total,omitempty"` // Total number of transactions in the requested range.
}
...
func (x *TransactionList) GetTotal() uint64 {
	if x != nil {
		return x.Total
	}
	return 0
...
var file_spacemesh_v2alpha1_tx_proto_rawDesc = []byte{
	...
	0x61, 0x74, 0x65, 0x22, 0x74, 0x0a, 0x0f, 0x54, 0x72, 0x61, 0x6e, 0x73, 0x61, 0x63, 0x74, 0x69,
	...
	0x28, 0x04, 0x52, 0x05, 0x74, 0x6f, 0x74, 0x61, 0x6c, 0x22, 0x53, 0x0a, 0x17, 0x50, 0x61, 0x72,
