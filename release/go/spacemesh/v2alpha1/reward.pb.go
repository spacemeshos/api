...
type RewardList struct {
	...
	Total   uint64    `protobuf:"varint,2,opt,name=total,proto3" json:"total,omitempty"` // Total number of rewards in the requested range.
}
...
func (x *RewardList) GetTotal() uint64 {
	if x != nil {
		return x.Total
	}
	return 0
