...
var file_spacemesh_v1_smesher_proto_rawDesc = []byte{
	...
	0x70, 0x65, 0x73, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x32, 0xc3, 0x06, 0x0a, 0x0e, 0x53, 0x6d,
	...
	0x2e, 0x73, 0x70, 0x61, 0x63, 0x65, 0x6d, 0x65, 0x73, 0x68, 0x2e, 0x76, 0x31, 0x2e, 0x53, 0x65,
	0x74, 0x4d, 0x69, 0x6e, 0x47, 0x61, 0x73, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x42,
...
var file_spacemesh_v1_smesher_proto_goTypes = []interface{}{
	...
	(*PostComputeProvidersResponse)(nil),           // 8: spacemesh.v1.PostComputeProvidersResponse
	(*PostDataCreationProgressStreamResponse)(nil), // 9: spacemesh.v1.PostDataCreationProgressStreamResponse
...
var file_spacemesh_v1_smesher_proto_depIdxs = []int32{
	...
	8,  // 13: spacemesh.v1.SmesherService.PostComputeProviders:output_type -> spacemesh.v1.PostComputeProvidersResponse
	9,  // 14: spacemesh.v1.SmesherService.PostDataCreationProgressStream:output_type -> spacemesh.v1.PostDataCreationProgressStreamResponse
	10, // 15: spacemesh.v1.SmesherService.SmesherID:output_type -> spacemesh.v1.SmesherIDResponse
	11, // 16: spacemesh.v1.SmesherService.Coinbase:output_type -> spacemesh.v1.CoinbaseResponse
	12, // 17: spacemesh.v1.SmesherService.SetCoinbase:output_type -> spacemesh.v1.SetCoinbaseResponse
	13, // 18: spacemesh.v1.SmesherService.MinGas:output_type -> spacemesh.v1.MinGasResponse
	14, // 19: spacemesh.v1.SmesherService.SetMinGas:output_type -> spacemesh.v1.SetMinGasResponse
