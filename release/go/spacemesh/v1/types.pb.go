...
type Block struct {
	...
	Activation   *Activation    `protobuf:"bytes,3,opt,name=activation,proto3" json:"activation,omitempty"`     // the activation the block is referencing
}
...
func (x *Block) GetActivation() *Activation {
	if x != nil {
		return x.Activation
	}
	return nil
...
var file_spacemesh_v1_types_proto_rawDesc = []byte{
	...
	0x68, 0x65, 0x72, 0x49, 0x64, 0x52, 0x07, 0x73, 0x6d, 0x65, 0x73, 0x68, 0x65, 0x72, 0x22, 0x90,
	...
	0x61, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x73, 0x12, 0x38, 0x0a, 0x0a, 0x61, 0x63, 0x74, 0x69, 0x76,
	0x61, 0x74, 0x69, 0x6f, 0x6e, 0x18, 0x03, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x18, 0x2e, 0x73, 0x70,
	...
	0x6e, 0x22, 0xfc, 0x02, 0x0a, 0x05, 0x4c, 0x61, 0x79, 0x65, 0x72, 0x12, 0x31, 0x0a, 0x06, 0x6e,
	...
	0x6f, 0x6f, 0x74, 0x53, 0x74, 0x61, 0x74, 0x65, 0x48, 0x61, 0x73, 0x68, 0x22, 0x62, 0x0a, 0x0b,
	...
	0x22, 0x25, 0x0a, 0x0b, 0x4c, 0x61, 0x79, 0x65, 0x72, 0x4e, 0x75, 0x6d, 0x62, 0x65, 0x72, 0x12,
	0x16, 0x0a, 0x06, 0x6e, 0x75, 0x6d, 0x62, 0x65, 0x72, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0d, 0x52,
	0x06, 0x6e, 0x75, 0x6d, 0x62, 0x65, 0x72, 0x22, 0x68, 0x0a, 0x08, 0x41, 0x70, 0x70, 0x45, 0x76,
...
var file_spacemesh_v1_types_proto_depIdxs = []int32{
	...
	14, // 23: spacemesh.v1.Block.activation:type_name -> spacemesh.v1.Activation
	19, // 24: spacemesh.v1.Layer.number:type_name -> spacemesh.v1.LayerNumber
	2,  // 25: spacemesh.v1.Layer.status:type_name -> spacemesh.v1.Layer.LayerStatus
	17, // 26: spacemesh.v1.Layer.blocks:type_name -> spacemesh.v1.Block
	14, // 27: spacemesh.v1.Layer.activations:type_name -> spacemesh.v1.Activation
	7,  // 28: spacemesh.v1.AppEvent.transaction_id:type_name -> spacemesh.v1.TransactionId
