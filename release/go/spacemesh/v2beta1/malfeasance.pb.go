...
const file_spacemesh_v2beta1_malfeasance_proto_rawDesc = "" +
	"\n" +
	"#spacemesh/v2beta1/malfeasance.proto\x12\x11spacemesh.v2beta1\x1a\x1cgoogle/api/annotations.proto\x1a\x1bgoogle/api/visibility.proto\"\x8b\x03\n" +
	"\x10MalfeasanceProof\x12\x18\n" +
	"\asmesher\x18\x01 \x01(\fR\asmesher\x12M\n" +
	"\x06domain\x18\x02 \x01(\x0e25.spacemesh.v2beta1.MalfeasanceProof.MalfeasanceDomainR\x06domain\x12\x12\n" +
	"\x04type\x18\x03 \x01(\rR\x04type\x12S\n" +
	"\n" +
	"properties\x18\x04 \x03(\v23.spacemesh.v2beta1.MalfeasanceProof.PropertiesEntryR\n" +
	"properties\x1a=\n" +
	...
	"\x06proofs\x18\x01 \x03(\v2#.spacemesh.v2beta1.MalfeasanceProofR\x06proofs\"O\n" +
	"\x18MalfeasanceStreamRequest\x12\x1d\n" +
	"\n" +
	"smesher_id\x18\x01 \x03(\fR\tsmesherId\x12\x14\n" +
	"\x05watch\x18\x02 \x01(\bR\x05watch2\xad\x01\n" +
	"\x12MalfeasanceService\x12\x85\x01\n" +
	"\x04List\x12%.spacemesh.v2beta1.MalfeasanceRequest\x1a\".spacemesh.v2beta1.MalfeasanceList\"2\x82\xd3\xe4\x93\x02,\x12*/spacemesh.v2beta1.MalfeasanceService/List\x1a\x0f\xfa\xd2\xe4\x93\x02\t\x12\av2beta12\x8a\x01\n" +
	"\x18MalfeasanceStreamService\x12\\\n" +
	"\x06Stream\x12+.spacemesh.v2beta1.MalfeasanceStreamRequest\x1a#.spacemesh.v2beta1.MalfeasanceProof0\x01\x1a\x10\xfa\xd2\xe4\x93\x02\n" +
	"\x12\bINTERNALB\xd8\x01\n" +
	"\x15com.spacemesh.v2beta1B\x10MalfeasanceProtoP\x01ZHgithub.com/spacemeshos/api/release/go/spacemesh/v2beta1;spacemeshv2beta1\xa2\x02\x03SXX\xaa\x02\x11Spacemesh.V2beta1\xca\x02\x11Spacemesh\\V2beta1\xe2\x02\x1dSpacemesh\\V2beta1\\GPBMetadata\xea\x02\x12Spacemesh::V2beta1b\x06proto3"

var (
	file_spacemesh_v2beta1_malfeasance_proto_rawDescOnce sync.Once
	file_spacemesh_v2beta1_malfeasance_proto_rawDescData []byte
)
...
func file_spacemesh_v2beta1_malfeasance_proto_rawDescGZIP() []byte {
	file_spacemesh_v2beta1_malfeasance_proto_rawDescOnce.Do(func() {
		file_spacemesh_v2beta1_malfeasance_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_spacemesh_v2beta1_malfeasance_proto_rawDesc), len(file_spacemesh_v2beta1_malfeasance_proto_rawDesc)))
	})
...
var file_spacemesh_v2beta1_malfeasance_proto_goTypes = []any{
...
func file_spacemesh_v2beta1_malfeasance_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_spacemesh_v2beta1_malfeasance_proto_rawDesc), len(file_spacemesh_v2beta1_malfeasance_proto_rawDesc)),
			NumEnums:      1,
			NumMessages:   5,
			NumExtensions: 0,
			NumServices:   2,
