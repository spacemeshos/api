...
const file_spacemesh_v2beta1_activation_proto_rawDesc = "" +
	"\n" +
	"\"spacemesh/v2beta1/activation.proto\x12\x11spacemesh.v2beta1\x1a\x1cgoogle/api/annotations.proto\x1a\x1bgoogle/api/visibility.proto\"\xc9\x01\n" +
	"\n" +
	"Activation\x12\x0e\n" +
	...
	"\x05limit\x18\a \x01(\x04R\x05limit\"Q\n" +
	"\x0eActivationList\x12?\n" +
	"\vactivations\x18\x01 \x03(\v2\x1d.spacemesh.v2beta1.ActivationR\vactivations\">\n" +
	...
	"\n" +
	"activation\x18\x01 \x01(\v2\x1d.spacemesh.v2beta1.ActivationR\n" +
	"activation2\x82\x01\n" +
	"\x17ActivationStreamService\x12U\n" +
	"\x06Stream\x12*.spacemesh.v2beta1.ActivationStreamRequest\x1a\x1d.spacemesh.v2beta1.Activation0\x01\x1a\x10\xfa\xd2\xe4\x93\x02\n" +
	"\x12\bINTERNAL2\xdf\x03\n" +
	"\x11ActivationService\x12\x82\x01\n" +
	"\x04List\x12$.spacemesh.v2beta1.ActivationRequest\x1a!.spacemesh.v2beta1.ActivationList\"1\x82\xd3\xe4\x93\x02+\x12)/spacemesh.v2beta1.ActivationService/List\x12\xaa\x01\n" +
	"\x10ActivationsCount\x12*.spacemesh.v2beta1.ActivationsCountRequest\x1a+.spacemesh.v2beta1.ActivationsCountResponse\"=\x82\xd3\xe4\x93\x027\x125/spacemesh.v2beta1.ActivationService/ActivationsCount\x12\x86\x01\n" +
	"\aHighest\x12!.spacemesh.v2beta1.HighestRequest\x1a\".spacemesh.v2beta1.HighestResponse\"4\x82\xd3\xe4\x93\x02.\x12,/spacemesh.v2beta1.ActivationService/Highest\x1a\x0f\xfa\xd2\xe4\x93\x02\t\x12\av2beta1B\xd7\x01\n" +
	"\x15com.spacemesh.v2beta1B\x0fActivationProtoP\x01ZHgithub.com/spacemeshos/api/release/go/spacemesh/v2beta1;spacemeshv2beta1\xa2\x02\x03SXX\xaa\x02\x11Spacemesh.V2beta1\xca\x02\x11Spacemesh\\V2beta1\xe2\x02\x1dSpacemesh\\V2beta1\\GPBMetadata\xea\x02\x12Spacemesh::V2beta1b\x06proto3"

var (
	file_spacemesh_v2beta1_activation_proto_rawDescOnce sync.Once
	file_spacemesh_v2beta1_activation_proto_rawDescData []byte
)

func file_spacemesh_v2beta1_activation_proto_rawDescGZIP() []byte {
	file_spacemesh_v2beta1_activation_proto_rawDescOnce.Do(func() {
		file_spacemesh_v2beta1_activation_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_spacemesh_v2beta1_activation_proto_rawDesc), len(file_spacemesh_v2beta1_activation_proto_rawDesc)))
	})
...
var file_spacemesh_v2beta1_activation_proto_goTypes = []any{
...
func file_spacemesh_v2beta1_activation_proto_init() {
	...
	file_spacemesh_v2beta1_activation_proto_msgTypes[4].OneofWrappers = []any{}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_spacemesh_v2beta1_activation_proto_rawDesc), len(file_spacemesh_v2beta1_activation_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   8,
			NumExtensions: 0,
			NumServices:   2,
