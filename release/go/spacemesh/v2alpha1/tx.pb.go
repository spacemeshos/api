...
const file_spacemesh_v2alpha1_tx_proto_rawDesc = "" +
	"\n" +
	"\x1bspacemesh/v2alpha1/tx.proto\x12\x12spacemesh.v2alpha1\x1a\x17google/rpc/status.proto\x1a\x1bgoogle/api/visibility.proto\x1a!spacemesh/v2alpha1/v2alpha1.proto\"\xa2\x06\n" +
	...
	"\x05nonce\x18\x05 \x01(\v2\x19.spacemesh.v2alpha1.NonceR\x05nonce\x12\x17\n" +
	...
	"\x03raw\x18\t \x01(\fR\x03raw\x12C\n" +
	"\x04type\x18\n" +
	" \x01(\x0e2/.spacemesh.v2alpha1.Transaction.TransactionTypeR\x04type\x12C\n" +
	"\bcontents\x18\v \x01(\v2'.spacemesh.v2alpha1.TransactionContentsR\bcontents\"\x90\x03\n" +
	...
	"\x06amount\x18\x03 \x01(\x04R\x06amount\"\xee\x03\n" +
	"\x13TransactionContents\x126\n" +
	"\x04send\x18\x01 \x01(\v2 .spacemesh.v2alpha1.ContentsSendH\x00R\x04send\x12V\n" +
	"\x10single_sig_spawn\x18\x02 \x01(\v2*.spacemesh.v2alpha1.ContentsSingleSigSpawnH\x00R\x0esingleSigSpawn\x12S\n" +
	"\x0fmulti_sig_spawn\x18\x03 \x01(\v2).spacemesh.v2alpha1.ContentsMultiSigSpawnH\x00R\rmultiSigSpawn\x12P\n" +
	"\rvesting_spawn\x18\x04 \x01(\v2).spacemesh.v2alpha1.ContentsMultiSigSpawnH\x00R\fvestingSpawn\x12I\n" +
	"\vvault_spawn\x18\x05 \x01(\v2&.spacemesh.v2alpha1.ContentsVaultSpawnH\x00R\n" +
	"vaultSpawn\x12I\n" +
	"\vdrain_vault\x18\x06 \x01(\v2&.spacemesh.v2alpha1.ContentsDrainVaultH\x00R\n" +
	"drainVaultB\n" +
	"\n" +
	"\bcontents\"!\n" +
	"\x05Nonce\x12\x18\n" +
	"\acounter\x18\x01 \x01(\x04R\acounter\"\x90\x03\n" +
	"\x11TransactionResult\x12D\n" +
	"\x06status\x18\x01 \x01(\x0e2,.spacemesh.v2alpha1.TransactionResult.StatusR\x06status\x12\x18\n" +
	...
	"\n" +
	"sort_order\x18\n" +
	" \x01(\x0e2\x1d.spacemesh.v2alpha1.SortOrderR\tsortOrderB\x0e\n" +
	"\f_start_layerB\f\n" +
	"\n" +
	"_end_layerB\n" +
	"\n" +
	...
	"\x02tx\x18\x01 \x01(\v2\x1f.spacemesh.v2alpha1.TransactionR\x02tx\x12B\n" +
	"\ttx_result\x18\x02 \x01(\v2%.spacemesh.v2alpha1.TransactionResultR\btxResult\x12D\n" +
	"\btx_state\x18\x03 \x01(\x0e2$.spacemesh.v2alpha1.TransactionStateH\x00R\atxState\x88\x01\x01B\v\n" +
	"\t_tx_state\"^\n" +
	"\x0fTransactionList\x12K\n" +
	"\ftransactions\x18\x01 \x03(\v2'.spacemesh.v2alpha1.TransactionResponseR\ftransactions\"S\n" +
	"\x17ParseTransactionRequest\x12 \n" +
	"\vtransaction\x18\x01 \x01(\fR\vtransaction\x12\x16\n" +
	"\x06verify\x18\x02 \x01(\bR\x06verify\"w\n" +
	"\x18ParseTransactionResponse\x12*\n" +
	"\x06status\x18\x01 \x01(\v2\x12.google.rpc.StatusR\x06status\x12/\n" +
	"\x02tx\x18\x02 \x01(\v2\x1f.spacemesh.v2alpha1.TransactionR\x02tx\"<\n" +
	...
	"\x1dTRANSACTION_STATE_INEFFECTUAL\x10\a2\x8f\x01\n" +
	"\x18TransactionStreamService\x12a\n" +
	"\x06Stream\x12,.spacemesh.v2alpha1.TransactionStreamRequest\x1a'.spacemesh.v2alpha1.TransactionResponse0\x01\x1a\x10\xfa\xd2\xe4\x93\x02\n" +
	"\x12\bINTERNAL2\xb6\x03\n" +
	"\x12TransactionService\x12S\n" +
	"\x04List\x12&.spacemesh.v2alpha1.TransactionRequest\x1a#.spacemesh.v2alpha1.TransactionList\x12m\n" +
	"\x10ParseTransaction\x12+.spacemesh.v2alpha1.ParseTransactionRequest\x1a,.spacemesh.v2alpha1.ParseTransactionResponse\x12p\n" +
	"\x11SubmitTransaction\x12,.spacemesh.v2alpha1.SubmitTransactionRequest\x1a-.spacemesh.v2alpha1.SubmitTransactionResponse\x12^\n" +
	"\vEstimateGas\x12&.spacemesh.v2alpha1.EstimateGasRequest\x1a'.spacemesh.v2alpha1.EstimateGasResponse\x1a\n" +
	"\xfa\xd2\xe4\x93\x02\x04\x12\x02V2B\xd6\x01\n" +
	"\x16com.spacemesh.v2alpha1B\aTxProtoP\x01ZJgithub.com/spacemeshos/api/release/go/spacemesh/v2alpha1;spacemeshv2alpha1\xa2\x02\x03SXX\xaa\x02\x12Spacemesh.V2alpha1\xca\x02\x12Spacemesh\\V2alpha1\xe2\x02\x1eSpacemesh\\V2alpha1\\GPBMetadata\xea\x02\x13Spacemesh::V2alpha1b\x06proto3"

var (
	file_spacemesh_v2alpha1_tx_proto_rawDescOnce sync.Once
	file_spacemesh_v2alpha1_tx_proto_rawDescData []byte
)

func file_spacemesh_v2alpha1_tx_proto_rawDescGZIP() []byte {
	file_spacemesh_v2alpha1_tx_proto_rawDescOnce.Do(func() {
		file_spacemesh_v2alpha1_tx_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_spacemesh_v2alpha1_tx_proto_rawDesc), len(file_spacemesh_v2alpha1_tx_proto_rawDesc)))
	})
...
var file_spacemesh_v2alpha1_tx_proto_goTypes = []any{
...
func file_spacemesh_v2alpha1_tx_proto_init() {
	...
	file_spacemesh_v2alpha1_tx_proto_msgTypes[6].OneofWrappers = []any{
	...
	file_spacemesh_v2alpha1_tx_proto_msgTypes[9].OneofWrappers = []any{}
	file_spacemesh_v2alpha1_tx_proto_msgTypes[10].OneofWrappers = []any{}
	file_spacemesh_v2alpha1_tx_proto_msgTypes[11].OneofWrappers = []any{}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_spacemesh_v2alpha1_tx_proto_rawDesc), len(file_spacemesh_v2alpha1_tx_proto_rawDesc)),
			NumEnums:      3,
			NumMessages:   19,
			NumExtensions: 0,
			NumServices:   2,
