...
type GlobalStateData struct {
	...
	Data isGlobalStateData_Data `protobuf_oneof:"data"`
}
...
func (m *GlobalStateData) GetData() isGlobalStateData_Data {
	if m != nil {
		return m.Data
	}
	return nil
...
func (x *GlobalStateData) GetReward() *Reward {
	if x, ok := x.GetData().(*GlobalStateData_Reward); ok {
		return x.Reward
	}
	return nil
}
...
func (x *GlobalStateData) GetReceipt() *TransactionReceipt {
	if x, ok := x.GetData().(*GlobalStateData_Receipt); ok {
		return x.Receipt
	}
	return nil
}
...
func (x *GlobalStateData) GetAccountWrapper() *Account {
	if x, ok := x.GetData().(*GlobalStateData_AccountWrapper); ok {
		return x.AccountWrapper
	}
	return nil
}
...
func (x *GlobalStateData) GetGlobalState() *GlobalStateHash {
	if x, ok := x.GetData().(*GlobalStateData_GlobalState); ok {
		return x.GlobalState
	}
	return nil
}

type isGlobalStateData_Data interface {
	isGlobalStateData_Data()
}
...
func (*GlobalStateData_Reward) isGlobalStateData_Data() {}

func (*GlobalStateData_Receipt) isGlobalStateData_Data() {}

func (*GlobalStateData_AccountWrapper) isGlobalStateData_Data() {}

func (*GlobalStateData_GlobalState) isGlobalStateData_Data() {}
...
type GlobalStateStreamResponse struct {
	...
	Item *GlobalStateData `protobuf:"bytes,1,opt,name=item,proto3" json:"item,omitempty"`
}
...
func (x *GlobalStateStreamResponse) GetItem() *GlobalStateData {
	if x != nil {
		return x.Item
	}
	return nil
...
var file_spacemesh_v1_global_state_types_proto_rawDesc = []byte{
	...
	0x61, 0x74, 0x61, 0x46, 0x6c, 0x61, 0x67, 0x73, 0x22, 0x8d, 0x02, 0x0a, 0x0f, 0x47, 0x6c, 0x6f,
	...
	0x42, 0x06, 0x0a, 0x04, 0x64, 0x61, 0x74, 0x61, 0x22, 0x4e, 0x0a, 0x19, 0x47, 0x6c, 0x6f, 0x62,
	...
	0x76, 0x31, 0x2e, 0x47, 0x6c, 0x6f, 0x62, 0x61, 0x6c, 0x53, 0x74, 0x61, 0x74, 0x65, 0x44, 0x61,
	0x74, 0x61, 0x52, 0x04, 0x69, 0x74, 0x65, 0x6d, 0x22, 0x17, 0x0a, 0x15, 0x41, 0x70, 0x70, 0x45,
...
var file_spacemesh_v1_global_state_types_proto_depIdxs = []int32{
	...
	20, // 23: spacemesh.v1.GlobalStateStreamResponse.item:type_name -> spacemesh.v1.GlobalStateData
