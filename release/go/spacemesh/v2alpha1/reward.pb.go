...
const file_spacemesh_v2alpha1_reward_proto_rawDesc = "" +
	"\n" +
	"\x1fspacemesh/v2alpha1/reward.proto\x12\x12spacemesh.v2alpha1\x1a\x1bgoogle/api/visibility.proto\x1a!spacemesh/v2alpha1/v2alpha1.proto\"\x8d\x01\n" +
	"\x06Reward\x12\x14\n" +
	...
	"\asmesher\x18\x06 \x01(\fR\asmesher\"\x80\x02\n" +
	...
	"\n" +
	"sort_order\x18\a \x01(\x0e2\x1d.spacemesh.v2alpha1.SortOrderR\tsortOrderB\v\n" +
	"\tfilter_by\"B\n" +
	"\n" +
	"RewardList\x124\n" +
	"\arewards\x18\x01 \x03(\v2\x1a.spacemesh.v2alpha1.RewardR\arewards\"\xb0\x01\n" +
	...
	"\tfilter_by2f\n" +
	"\rRewardService\x12I\n" +
	"\x04List\x12!.spacemesh.v2alpha1.RewardRequest\x1a\x1e.spacemesh.v2alpha1.RewardList\x1a\n" +
	"\xfa\xd2\xe4\x93\x02\x04\x12\x02V22x\n" +
	"\x13RewardStreamService\x12O\n" +
	"\x06Stream\x12'.spacemesh.v2alpha1.RewardStreamRequest\x1a\x1a.spacemesh.v2alpha1.Reward0\x01\x1a\x10\xfa\xd2\xe4\x93\x02\n" +
	"\x12\bINTERNALB\xda\x01\n" +
	"\x16com.spacemesh.v2alpha1B\vRewardProtoP\x01ZJgithub.com/spacemeshos/api/release/go/spacemesh/v2alpha1;spacemeshv2alpha1\xa2\x02\x03SXX\xaa\x02\x12Spacemesh.V2alpha1\xca\x02\x12Spacemesh\\V2alpha1\xe2\x02\x1eSpacemesh\\V2alpha1\\GPBMetadata\xea\x02\x13Spacemesh::V2alpha1b\x06proto3"

var (
	file_spacemesh_v2alpha1_reward_proto_rawDescOnce sync.Once
	file_spacemesh_v2alpha1_reward_proto_rawDescData []byte
)

func file_spacemesh_v2alpha1_reward_proto_rawDescGZIP() []byte {
	file_spacemesh_v2alpha1_reward_proto_rawDescOnce.Do(func() {
		file_spacemesh_v2alpha1_reward_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_spacemesh_v2alpha1_reward_proto_rawDesc), len(file_spacemesh_v2alpha1_reward_proto_rawDesc)))
	})
...
var file_spacemesh_v2alpha1_reward_proto_goTypes = []any{
...
func file_spacemesh_v2alpha1_reward_proto_init() {
	...
	file_spacemesh_v2alpha1_reward_proto_msgTypes[1].OneofWrappers = []any{
		(*RewardRequest_Coinbase)(nil),
		(*RewardRequest_Smesher)(nil),
	}
	file_spacemesh_v2alpha1_reward_proto_msgTypes[3].OneofWrappers = []any{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_spacemesh_v2alpha1_reward_proto_rawDesc), len(file_spacemesh_v2alpha1_reward_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   4,
			NumExtensions: 0,
			NumServices:   2,
