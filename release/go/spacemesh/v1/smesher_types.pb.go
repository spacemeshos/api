...
type SmeshingStatus_EpochStatus int32

const (
	SmeshingStatus_EPOCH_STATUS_UNSPECIFIED    SmeshingStatus_EpochStatus = 0
	SmeshingStatus_EPOCH_STATUS_POST_NOT_FOUND SmeshingStatus_EpochStatus = 1 // No ATX and creation of post not started yet.
	SmeshingStatus_EPOCH_STATUS_INITIALIZING   SmeshingStatus_EpochStatus = 2 // When node start create post file.
	SmeshingStatus_EPOCH_STATUS_GENERATING     SmeshingStatus_EpochStatus = 3 // Generating Proof-of-Space
	SmeshingStatus_EPOCH_STATUS_WAITING        SmeshingStatus_EpochStatus = 4 // Waiting for PoET challenge
	SmeshingStatus_EPOCH_STATUS_SMESHING       SmeshingStatus_EpochStatus = 5
)

// Enum value maps for SmeshingStatus_EpochStatus.
var (
	SmeshingStatus_EpochStatus_name = map[int32]string{
		0: "EPOCH_STATUS_UNSPECIFIED",
		1: "EPOCH_STATUS_POST_NOT_FOUND",
		2: "EPOCH_STATUS_INITIALIZING",
		3: "EPOCH_STATUS_GENERATING",
		4: "EPOCH_STATUS_WAITING",
		5: "EPOCH_STATUS_SMESHING",
	}
	SmeshingStatus_EpochStatus_value = map[string]int32{
		"EPOCH_STATUS_UNSPECIFIED":    0,
		"EPOCH_STATUS_POST_NOT_FOUND": 1,
		"EPOCH_STATUS_INITIALIZING":   2,
		"EPOCH_STATUS_GENERATING":     3,
		"EPOCH_STATUS_WAITING":        4,
		"EPOCH_STATUS_SMESHING":       5,
	}
)

func (x SmeshingStatus_EpochStatus) Enum() *SmeshingStatus_EpochStatus {
	p := new(SmeshingStatus_EpochStatus)
	*p = x
	return p
}

func (x SmeshingStatus_EpochStatus) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (SmeshingStatus_EpochStatus) Descriptor() protoreflect.EnumDescriptor {
	return file_spacemesh_v1_smesher_types_proto_enumTypes[2].Descriptor()
}

func (SmeshingStatus_EpochStatus) Type() protoreflect.EnumType {
	return &file_spacemesh_v1_smesher_types_proto_enumTypes[2]
}

func (x SmeshingStatus_EpochStatus) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use SmeshingStatus_EpochStatus.Descriptor instead.
func (SmeshingStatus_EpochStatus) EnumDescriptor() ([]byte, []int) {
	return file_spacemesh_v1_smesher_types_proto_rawDescGZIP(), []int{23, 0}
}
...
type PostSetupStatus struct {
	...
	ProcessedBytes     uint64                `protobuf:"varint,5,opt,name=processed_bytes,json=processedBytes,proto3" json:"processed_bytes,omitempty"`                 // The processed size, in bytes
	PostTotalSizeBytes uint64                `protobuf:"varint,6,opt,name=post_total_size_bytes,json=postTotalSizeBytes,proto3" json:"post_total_size_bytes,omitempty"` // Total size, that should be processed
}
...
func (x *PostSetupStatus) GetProcessedBytes() uint64 {
	if x != nil {
...
func (x *PostSetupStatus) GetPostTotalSizeBytes() uint64 {
	if x != nil {
		return x.PostTotalSizeBytes
	}
	return 0
}
...
type SmeshingStatusResponse struct {
	...
	Epoch []*SmeshingStatus `protobuf:"bytes,1,rep,name=epoch,proto3" json:"epoch,omitempty"`
}
...
func (x *SmeshingStatusResponse) GetEpoch() []*SmeshingStatus {
	if x != nil {
		return x.Epoch
	}
	return nil
...
type SmeshingStatus struct {
	...
	Status        SmeshingStatus_EpochStatus `protobuf:"varint,1,opt,name=status,proto3,enum=spacemesh.v1.SmeshingStatus_EpochStatus" json:"status,omitempty"`
	Epoch         *SimpleInt                 `protobuf:"bytes,2,opt,name=epoch,proto3" json:"epoch,omitempty"`
	EstimatedTime uint64                     `protobuf:"varint,3,opt,name=estimated_time,json=estimatedTime,proto3" json:"estimated_time,omitempty"` // Estimated time to complete, in seconds.
...
func (x *SmeshingStatus) GetStatus() SmeshingStatus_EpochStatus {
	if x != nil {
		return x.Status
	}
	return SmeshingStatus_EPOCH_STATUS_UNSPECIFIED
}

func (x *SmeshingStatus) GetEpoch() *SimpleInt {
	if x != nil {
		return x.Epoch
	}
	return nil
...
func (x *SmeshingStatus) GetEstimatedTime() uint64 {
	if x != nil {
...
func (x *SmeshingStatus) GetReason() string {
	if x != nil {
		return x.Reason
	}
	return ""
...
var file_spacemesh_v1_smesher_types_proto_rawDesc = []byte{
	...
	0x6c, 0x65, 0x22, 0x9f, 0x03, 0x0a, 0x0f, 0x50, 0x6f, 0x73, 0x74, 0x53, 0x65, 0x74, 0x75, 0x70,
	...
	0x65, 0x64, 0x5f, 0x62, 0x79, 0x74, 0x65, 0x73, 0x18, 0x05, 0x20, 0x01, 0x28, 0x04, 0x52, 0x0e,
	0x70, 0x72, 0x6f, 0x63, 0x65, 0x73, 0x73, 0x65, 0x64, 0x42, 0x79, 0x74, 0x65, 0x73, 0x12, 0x31,
	0x0a, 0x15, 0x70, 0x6f, 0x73, 0x74, 0x5f, 0x74, 0x6f, 0x74, 0x61, 0x6c, 0x5f, 0x73, 0x69, 0x7a,
	0x65, 0x5f, 0x62, 0x79, 0x74, 0x65, 0x73, 0x18, 0x06, 0x20, 0x01, 0x28, 0x04, 0x52, 0x12, 0x70,
	0x6f, 0x73, 0x74, 0x54, 0x6f, 0x74, 0x61, 0x6c, 0x53, 0x69, 0x7a, 0x65, 0x42, 0x79, 0x74, 0x65,
	...
	,
	...
	,
...
var file_spacemesh_v1_smesher_types_proto_goTypes = []interface{}{
	...
	(SmeshingStatus_EpochStatus)(0),               // 2: spacemesh.v1.SmeshingStatus.EpochStatus
	...
	(*StopSmeshingRequest)(nil),                   // 6: spacemesh.v1.StopSmeshingRequest
	(*StopSmeshingResponse)(nil),                  // 7: spacemesh.v1.StopSmeshingResponse
	(*SetCoinbaseRequest)(nil),                    // 8: spacemesh.v1.SetCoinbaseRequest
	(*SetCoinbaseResponse)(nil),                   // 9: spacemesh.v1.SetCoinbaseResponse
	(*MinGasResponse)(nil),                        // 10: spacemesh.v1.MinGasResponse
	(*SetMinGasRequest)(nil),                      // 11: spacemesh.v1.SetMinGasRequest
	(*SetMinGasResponse)(nil),                     // 12: spacemesh.v1.SetMinGasResponse
	(*SmesherIDResponse)(nil),                     // 13: spacemesh.v1.SmesherIDResponse
	(*CoinbaseResponse)(nil),                      // 14: spacemesh.v1.CoinbaseResponse
	(*EstimatedRewardsRequest)(nil),               // 15: spacemesh.v1.EstimatedRewardsRequest
	(*EstimatedRewardsResponse)(nil),              // 16: spacemesh.v1.EstimatedRewardsResponse
	(*PostSetupComputeProvidersRequest)(nil),      // 17: spacemesh.v1.PostSetupComputeProvidersRequest
	(*PostSetupComputeProvidersResponse)(nil),     // 18: spacemesh.v1.PostSetupComputeProvidersResponse
	(*PostSetupStatusResponse)(nil),               // 19: spacemesh.v1.PostSetupStatusResponse
	(*PostSetupStatusStreamResponse)(nil),         // 20: spacemesh.v1.PostSetupStatusStreamResponse
	(*PostConfigResponse)(nil),                    // 21: spacemesh.v1.PostConfigResponse
	(*PostSetupComputeProvider)(nil),              // 22: spacemesh.v1.PostSetupComputeProvider
	(*PostSetupOpts)(nil),                         // 23: spacemesh.v1.PostSetupOpts
	(*PostSetupStatus)(nil),                       // 24: spacemesh.v1.PostSetupStatus
	(*SmeshingStatusResponse)(nil),                // 25: spacemesh.v1.SmeshingStatusResponse
	(*SmeshingStatus)(nil),                        // 26: spacemesh.v1.SmeshingStatus
	(*AccountId)(nil),                             // 27: spacemesh.v1.AccountId
	(*status.Status)(nil),                         // 28: google.rpc.Status
	(*SimpleInt)(nil),                             // 29: spacemesh.v1.SimpleInt
...
var file_spacemesh_v1_smesher_types_proto_depIdxs = []int32{
	...
	23, // 1: spacemesh.v1.StartSmeshingRequest.opts:type_name -> spacemesh.v1.PostSetupOpts
	28, // 2: spacemesh.v1.StartSmeshingResponse.status:type_name -> google.rpc.Status
	28, // 3: spacemesh.v1.StopSmeshingResponse.status:type_name -> google.rpc.Status
	27, // 4: spacemesh.v1.SetCoinbaseRequest.id:type_name -> spacemesh.v1.AccountId
	28, // 5: spacemesh.v1.SetCoinbaseResponse.status:type_name -> google.rpc.Status
	29, // 6: spacemesh.v1.MinGasResponse.mingas:type_name -> spacemesh.v1.SimpleInt
	29, // 7: spacemesh.v1.SetMinGasRequest.mingas:type_name -> spacemesh.v1.SimpleInt
	28, // 8: spacemesh.v1.SetMinGasResponse.status:type_name -> google.rpc.Status
	27, // 9: spacemesh.v1.SmesherIDResponse.account_id:type_name -> spacemesh.v1.AccountId
	27, // 10: spacemesh.v1.CoinbaseResponse.account_id:type_name -> spacemesh.v1.AccountId
	30, // 11: spacemesh.v1.EstimatedRewardsResponse.amount:type_name -> spacemesh.v1.Amount
	22, // 12: spacemesh.v1.PostSetupComputeProvidersResponse.providers:type_name -> spacemesh.v1.PostSetupComputeProvider
	24, // 13: spacemesh.v1.PostSetupStatusResponse.status:type_name -> spacemesh.v1.PostSetupStatus
	24, // 14: spacemesh.v1.PostSetupStatusStreamResponse.status:type_name -> spacemesh.v1.PostSetupStatus
	...
	23, // 17: spacemesh.v1.PostSetupStatus.opts:type_name -> spacemesh.v1.PostSetupOpts
	26, // 18: spacemesh.v1.SmeshingStatusResponse.epoch:type_name -> spacemesh.v1.SmeshingStatus
	2,  // 19: spacemesh.v1.SmeshingStatus.status:type_name -> spacemesh.v1.SmeshingStatus.EpochStatus
	29, // 20: spacemesh.v1.SmeshingStatus.epoch:type_name -> spacemesh.v1.SimpleInt
