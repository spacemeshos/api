...
var file_spacemesh_v1_gateway_proto_rawDesc = []byte{
	...
	,
...
var file_spacemesh_v1_gateway_proto_goTypes = []interface{}{
	...
	(*VerifyChallengeRequest)(nil),  // 1: spacemesh.v1.VerifyChallengeRequest
	(*BroadcastPoetResponse)(nil),   // 2: spacemesh.v1.BroadcastPoetResponse
...
var file_spacemesh_v1_gateway_proto_depIdxs = []int32{
	...
	1, // 1: spacemesh.v1.GatewayService.VerifyChallenge:input_type -> spacemesh.v1.VerifyChallengeRequest
	2, // 2: spacemesh.v1.GatewayService.BroadcastPoet:output_type -> spacemesh.v1.BroadcastPoetResponse
	3, // 3: spacemesh.v1.GatewayService.VerifyChallenge:output_type -> spacemesh.v1.VerifyChallengeResponse
...
func (c *gatewayServiceClient) VerifyChallenge(ctx context.Context, in *VerifyChallengeRequest, opts ...grpc.CallOption) (*VerifyChallengeResponse, error) {
	out := new(VerifyChallengeResponse)
	err := c.cc.Invoke(ctx, "/spacemesh.v1.GatewayService/VerifyChallenge", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (*UnimplementedGatewayServiceServer) VerifyChallenge(context.Context, *VerifyChallengeRequest) (*VerifyChallengeResponse, error) {
...
func _GatewayService_VerifyChallenge_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(VerifyChallengeRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(GatewayServiceServer).VerifyChallenge(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/spacemesh.v1.GatewayService/VerifyChallenge",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(GatewayServiceServer).VerifyChallenge(ctx, req.(*VerifyChallengeRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var _GatewayService_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _GatewayService_VerifyChallenge_Handler,
		},
	},
