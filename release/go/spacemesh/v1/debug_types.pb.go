...
type Proposal struct {
	...
	Layer   *LayerNumber `protobuf:"bytes,1,opt,name=layer,proto3" json:"layer,omitempty"`
	Smesher *SmesherId   `protobuf:"bytes,2,opt,name=smesher,proto3" json:"smesher,omitempty"`
	// Types that are assignable to EpochData:
	//	*Proposal_Reference
	//	*Proposal_Data
	EpochData     isProposal_EpochData `protobuf_oneof:"epoch_data"`
	Ballot        []byte               `protobuf:"bytes,5,opt,name=ballot,proto3" json:"ballot,omitempty"`
	Eligibilities []*Eligibility       `protobuf:"bytes,6,rep,name=eligibilities,proto3" json:"eligibilities,omitempty"`
	Status        Proposal_Status      `protobuf:"varint,7,opt,name=status,proto3,enum=spacemesh.v1.Proposal_Status" json:"status,omitempty"`
}
...
type Proposal_Data struct {
	Data *EpochData `protobuf:"bytes,4,opt,name=data,proto3,oneof"`
}
...
var file_spacemesh_v1_debug_types_proto_rawDesc = []byte{
	...
	0x09, 0x73, 0x69, 0x67, 0x6e, 0x61, 0x74, 0x75, 0x72, 0x65, 0x22, 0x80, 0x03, 0x0a, 0x08, 0x50,
	0x72, 0x6f, 0x70, 0x6f, 0x73, 0x61, 0x6c, 0x12, 0x2f, 0x0a, 0x05, 0x6c, 0x61, 0x79, 0x65, 0x72,
	...
	0x68, 0x65, 0x72, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x17, 0x2e, 0x73, 0x70, 0x61, 0x63,
	...
	0x61, 0x74, 0x61, 0x18, 0x04, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x17, 0x2e, 0x73, 0x70, 0x61, 0x63,
	...
	0x6c, 0x6c, 0x6f, 0x74, 0x18, 0x05, 0x20, 0x01, 0x28, 0x0c, 0x52, 0x06, 0x62, 0x61, 0x6c, 0x6c,
	0x6f, 0x74, 0x12, 0x3f, 0x0a, 0x0d, 0x65, 0x6c, 0x69, 0x67, 0x69, 0x62, 0x69, 0x6c, 0x69, 0x74,
	0x69, 0x65, 0x73, 0x18, 0x06, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x19, 0x2e, 0x73, 0x70, 0x61, 0x63,
	...
	0x69, 0x65, 0x73, 0x12, 0x35, 0x0a, 0x06, 0x73, 0x74, 0x61, 0x74, 0x75, 0x73, 0x18, 0x07, 0x20,
	...
	0x0c, 0x0a, 0x0a, 0x65, 0x70, 0x6f, 0x63, 0x68, 0x5f, 0x64, 0x61, 0x74, 0x61, 0x42, 0x34, 0x5a,
...
var file_spacemesh_v1_debug_types_proto_goTypes = []interface{}{
	...
	(*LayerNumber)(nil),         // 7: spacemesh.v1.LayerNumber
...
var file_spacemesh_v1_debug_types_proto_depIdxs = []int32{
	...
	7, // 1: spacemesh.v1.Proposal.layer:type_name -> spacemesh.v1.LayerNumber
	8, // 2: spacemesh.v1.Proposal.smesher:type_name -> spacemesh.v1.SmesherId
	3, // 3: spacemesh.v1.Proposal.data:type_name -> spacemesh.v1.EpochData
	4, // 4: spacemesh.v1.Proposal.eligibilities:type_name -> spacemesh.v1.Eligibility
	0, // 5: spacemesh.v1.Proposal.status:type_name -> spacemesh.v1.Proposal.Status
