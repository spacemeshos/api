...
type SmesherServiceClient interface {
	...
	PostSetupStatusStream(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (grpc.ServerStreamingClient[PostSetupStatusStreamResponse], error)
...
func (c *smesherServiceClient) IsSmeshing(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*IsSmeshingResponse, error) {
	...
	err := c.cc.Invoke(ctx, SmesherService_IsSmeshing_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *smesherServiceClient) StartSmeshing(ctx context.Context, in *StartSmeshingRequest, opts ...grpc.CallOption) (*StartSmeshingResponse, error) {
	...
	err := c.cc.Invoke(ctx, SmesherService_StartSmeshing_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *smesherServiceClient) StopSmeshing(ctx context.Context, in *StopSmeshingRequest, opts ...grpc.CallOption) (*StopSmeshingResponse, error) {
	...
	err := c.cc.Invoke(ctx, SmesherService_StopSmeshing_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *smesherServiceClient) SmesherIDs(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*SmesherIDsResponse, error) {
	...
	err := c.cc.Invoke(ctx, SmesherService_SmesherIDs_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *smesherServiceClient) Coinbase(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*CoinbaseResponse, error) {
	...
	err := c.cc.Invoke(ctx, SmesherService_Coinbase_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *smesherServiceClient) SetCoinbase(ctx context.Context, in *SetCoinbaseRequest, opts ...grpc.CallOption) (*SetCoinbaseResponse, error) {
	...
	err := c.cc.Invoke(ctx, SmesherService_SetCoinbase_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *smesherServiceClient) PostSetupStatus(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*PostSetupStatusResponse, error) {
	...
	err := c.cc.Invoke(ctx, SmesherService_PostSetupStatus_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *smesherServiceClient) PostSetupStatusStream(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (grpc.ServerStreamingClient[PostSetupStatusStreamResponse], error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	stream, err := c.cc.NewStream(ctx, &SmesherService_ServiceDesc.Streams[0], SmesherService_PostSetupStatusStream_FullMethodName, cOpts...)
	if err != nil {
		return nil, err
	}
	x := &grpc.GenericClientStream[emptypb.Empty, PostSetupStatusStreamResponse]{ClientStream: stream}
...
type SmesherService_PostSetupStatusStreamClient = grpc.ServerStreamingClient[PostSetupStatusStreamResponse]
...
func (c *smesherServiceClient) PostSetupProviders(ctx context.Context, in *PostSetupProvidersRequest, opts ...grpc.CallOption) (*PostSetupProvidersResponse, error) {
	...
	err := c.cc.Invoke(ctx, SmesherService_PostSetupProviders_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *smesherServiceClient) PostConfig(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*PostConfigResponse, error) {
	...
	err := c.cc.Invoke(ctx, SmesherService_PostConfig_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type SmesherServiceServer interface {
	...
	// Returns a stream of updates for the Post setup status
	PostSetupStatusStream(*emptypb.Empty, grpc.ServerStreamingServer[PostSetupStatusStreamResponse]) error
	// Returns a list of available Post setup providers
...
// UnimplementedSmesherServiceServer should be embedded to have
...
func (UnimplementedSmesherServiceServer) PostSetupStatusStream(*emptypb.Empty, grpc.ServerStreamingServer[PostSetupStatusStreamResponse]) error {
...
func (UnimplementedSmesherServiceServer) testEmbeddedByValue() {}
...
func RegisterSmesherServiceServer(s grpc.ServiceRegistrar, srv SmesherServiceServer) {
	// If the following call pancis, it indicates UnimplementedSmesherServiceServer was
...
func _SmesherService_PostSetupStatusStream_Handler(srv interface{}, stream grpc.ServerStream) error {
	...
	return srv.(SmesherServiceServer).PostSetupStatusStream(m, &grpc.GenericServerStream[emptypb.Empty, PostSetupStatusStreamResponse]{ServerStream: stream})
}

// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type SmesherService_PostSetupStatusStreamServer = grpc.ServerStreamingServer[PostSetupStatusStreamResponse]
